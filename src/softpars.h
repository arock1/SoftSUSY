...
namespace softsusy {
  ...
  public:
    ...
    void FGMCaseB0(const MssmSusy & xx, double LAMBDA, 
		     double mMess, double cgrav); 
	void FGMCaseB1(const MssmSusy & xx, double LAMBDA, 
		     double mMess, double beta2, double beta3, double cgrav);
	void FGMCaseB1Alt(const MssmSusy & xx, double LAMBDA, 
		     double mMess, double beta2, double beta3, double cgrav);
	void FGMCaseB2(const MssmSusy & xx, double LAMBDA, 
		     double mMess, double beta2, double beta3, double cgrav); 
    ...
    void FGMCaseBNonRN2(const MssmSusy & xx, double LAMBDA, 
             double mMess, double beta2, double betaeps, double thetavev, double cgrav);
    void FGMCaseBNonRN3(const MssmSusy & xx, double LAMBDA, 

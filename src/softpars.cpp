...
// Boundary conditions to be applied at messenger scale for Gauge mediated
// SUSY breaking with messenger matter Mixing
...
void MssmSoftPars::FGMCaseB0(const MssmSusy & xx, double LAMBDA, 
  ...
  //Ql
a0= f * sqr(lambda) * (3.0*sqr(yb2) + 2.0*yb2*yt2 + yb2*(-0.466666666666667*g12 - 3.0*g22 - 5.33333333333333*g32 + 3.0*yb2 + 1.0*ytau2) + 3.0*sqr(yt2) + yt2*(-0.866666666666667*g12 - 3.0*g22 - 5.33333333333333*g32 + 3.0*yt2));
a1= f * sqr(lambda) * (0);
a2= f * sqr(lambda) * (0);
a3= f * sqr(lambda) * (0);
a4= f * sqr(lambda) * (3.0*sqr(yb2) + 2.0*yb2*yt2 + yb2*(-0.466666666666667*g12 - 3.0*g22 - 5.33333333333333*g32 + 3.0*yb2 + 1.0*ytau2) + 3.0*sqr(yt2) + yt2*(-0.866666666666667*g12 - 3.0*g22 - 5.33333333333333*g32 + 3.0*yt2));
a5= f * sqr(lambda) * (0);
a6= f * sqr(lambda) * (0);
a7= f * sqr(lambda) * (0);
a8= f * sqr(lambda) * (0);
  ...
  //Ur
a0=f * sqr(lambda) *(yt2*(-1.73333333333333*g12 - 6.0*g22 - 10.6666666666667*g32 + 2.0*yb2 + 12.0*yt2));
a1=f * sqr(lambda) *(0);
a2=f * sqr(lambda) *(0);
a3=f * sqr(lambda) *(0);
a4=f * sqr(lambda) *(yt2*(-1.73333333333333*g12 - 6.0*g22 - 10.6666666666667*g32 + 2.0*yb2 + 12.0*yt2));
a5=f * sqr(lambda) *(0);
a6=f * sqr(lambda) *(0);
a7=f * sqr(lambda) *(0);
a8=f * sqr(lambda) *(0);
 ...
 */
  ...
  //Dr
a0= f * sqr(lambda) * (yb2*(-0.933333333333333*g12 - 6.0*g22 - 10.6666666666667*g32 + 12.0*yb2 + 2.0*ytau2 + 2.0*yt2));
a1= f * sqr(lambda) * (0);
a2= f * sqr(lambda) * (0);
a3= f * sqr(lambda) * (0);
a4= f * sqr(lambda) * (yb2*(-0.933333333333333*g12 - 6.0*g22 - 10.6666666666667*g32 + 12.0*yb2 + 2.0*ytau2 + 2.0*yt2));
a5= f * sqr(lambda) * (0);
a6= f * sqr(lambda) * (0);
a7= f * sqr(lambda) * (0);
a8= f * sqr(lambda) * (0);
  ...
  //Ll
a0=f * sqr(lambda) *(ytau2*(-1.8*g12 - 3.0*g22 + 3.0*yb2 + 4.0*ytau2));
a1=f * sqr(lambda) *(0);
a2=f * sqr(lambda) *(0);
a3=f * sqr(lambda) *(0);
a4=f * sqr(lambda) *(ytau2*(-1.8*g12 - 3.0*g22 + 3.0*yb2 + 4.0*ytau2));
a5=f * sqr(lambda) *(0);
a6=f * sqr(lambda) *(0);
a7=f * sqr(lambda) *(0);
a8=f * sqr(lambda) *(0);
  ...
  //Er
a0=f * sqr(lambda) *(ytau2*(-3.6*g12 - 6.0*g22 + 6.0*yb2 + 8.0*ytau2));
a1=f * sqr(lambda) *(0);
a2=f * sqr(lambda) *(0);
a3=f * sqr(lambda) *(0);
a4=f * sqr(lambda) *(ytau2*(-3.6*g12 - 6.0*g22 + 6.0*yb2 + 8.0*ytau2));
a5=f * sqr(lambda) *(0);
a6=f * sqr(lambda) *(0);
a7=f * sqr(lambda) *(0);
a8=f * sqr(lambda) *(0);
  ...
  setMh1Squared(mllsq); //Hd
  setMh2Squared(mllsq); //Hu
...
void MssmSoftPars::FGMCaseB1(const MssmSusy & xx, double LAMBDA, 
  ...
  double delta2 = sqrt(sqr(beta2)+2.);
  double delta3 = sqrt(sqr(beta3)+2.);
  ...
  //Ql
a0= f * sqr(lambda) * ((-1.4*sqr(sqr(delta2))*sqr(delta3)*g12*yb2 - 2.6*sqr(sqr(delta2))*sqr(delta3)*g12*yt2 - 9.0*sqr(sqr(delta2))*sqr(delta3)*g22*yb2 - 9.0*sqr(sqr(delta2))*sqr(delta3)*g22*yt2 - 16.0*sqr(sqr(delta2))*sqr(delta3)*g32*yb2 - 16.0*sqr(sqr(delta2))*sqr(delta3)*g32*yt2 + 12.0*sqr(sqr(delta2))*sqr(delta3)*sqr(yb2) + 12.0*sqr(sqr(delta2))*sqr(delta3)*yb2*yt2 + 12.0*sqr(sqr(delta2))*sqr(delta3)*sqr(yt2) + 45.0*sqr(sqr(delta2))*sqr(yb2) + 9.0*sqr(sqr(delta2))*yb2*ytau2 + 45.0*sqr(sqr(delta2))*sqr(yt2) - 8.88178419700125e-16*sqr(delta2)*sqr(delta3)*g12*yb2 + 18.0*sqr(delta2)*sqr(delta3)*yb2*ytau2 - 36.0*sqr(delta2)*sqr(delta3)*yb2*yt2 - 162.0*sqr(delta2)*sqr(yb2) - 54.0*sqr(delta2)*yb2*ytau2 - 162.0*sqr(delta2)*sqr(yt2) - 27.0*sqr(delta3)*yb2*ytau2 + 54.0*sqr(delta3)*yb2*yt2 + 243.0*sqr(yb2) + 81.0*yb2*ytau2 + 243.0*sqr(yt2))/(sqr(sqr(delta2))*sqr(sqr(delta3))));
a1= f * sqr(lambda) * (0);
a2= f * sqr(lambda) * (0);
a3= f * sqr(lambda) * (0);
a4= f * sqr(lambda) * (-4.2*g12*yb2/sqr(delta3) - 7.8*g12*yt2/sqr(delta3) - 27.0*g22*yb2/sqr(delta3) - 27.0*g22*yt2/sqr(delta3) - 48.0*g32*yb2/sqr(delta3) - 48.0*g32*yt2/sqr(delta3) + 126.0*sqr(yb2)/sqr(delta3) + 18.0*yb2*ytau2/sqr(delta3) + 36.0*yb2*yt2/sqr(delta3) + 126.0*sqr(yt2)/sqr(delta3) + 8.4*g12*yb2/sqr(sqr(delta3)) + 15.6*g12*yt2/sqr(sqr(delta3)) + 54.0*g22*yb2/sqr(sqr(delta3)) + 54.0*g22*yt2/sqr(sqr(delta3)) + 96.0*g32*yb2/sqr(sqr(delta3)) + 96.0*g32*yt2/sqr(sqr(delta3)) - 387.0*sqr(yb2)/sqr(sqr(delta3)) - 63.0*yb2*ytau2/sqr(sqr(delta3)) - 72.0*yb2*yt2/sqr(sqr(delta3)) - 387.0*sqr(yt2)/sqr(sqr(delta3)) + 270.0*sqr(yb2)/(sqr(delta3)*sqr(sqr(delta3))) + 54.0*yb2*ytau2/(sqr(delta3)*sqr(sqr(delta3))) + 270.0*sqr(yt2)/(sqr(delta3)*sqr(sqr(delta3))) - 2.66453525910038e-15*g12*yb2/(sqr(delta2)*sqr(delta3)) - 1.77635683940025e-15*g12*yt2/(sqr(delta2)*sqr(delta3)) - 324.0*sqr(yb2)/(sqr(delta2)*sqr(delta3)) - 54.0*yb2*ytau2/(sqr(delta2)*sqr(delta3)) - 108.0*yb2*yt2/(sqr(delta2)*sqr(delta3)) - 324.0*sqr(yt2)/(sqr(delta2)*sqr(delta3)) + 5.32907051820083e-15*g12*yb2/(sqr(delta2)*sqr(sqr(delta3))) + 3.5527136788005e-15*g12*yt2/(sqr(delta2)*sqr(sqr(delta3))) + 1134.0*sqr(yb2)/(sqr(delta2)*sqr(sqr(delta3))) + 270.0*yb2*ytau2/(sqr(delta2)*sqr(sqr(delta3))) + 216.0*yb2*yt2/(sqr(delta2)*sqr(sqr(delta3))) + 1134.0*sqr(yt2)/(sqr(delta2)*sqr(sqr(delta3))) - 972.0*sqr(yb2)/(sqr(delta2)*(sqr(delta3)*sqr(sqr(delta3)))) - 324.0*yb2*ytau2/(sqr(delta2)*(sqr(delta3)*sqr(sqr(delta3)))) - 972.0*sqr(yt2)/(sqr(delta2)*(sqr(delta3)*sqr(sqr(delta3)))) + 486.0*sqr(yb2)/(sqr(sqr(delta2))*sqr(delta3)) + 81.0*yb2*ytau2/(sqr(sqr(delta2))*sqr(delta3)) + 162.0*yb2*yt2/(sqr(sqr(delta2))*sqr(delta3)) + 486.0*sqr(yt2)/(sqr(sqr(delta2))*sqr(delta3)) - 1701.0*sqr(yb2)/(sqr(sqr(delta2))*sqr(sqr(delta3))) - 405.0*yb2*ytau2/(sqr(sqr(delta2))*sqr(sqr(delta3))) - 324.0*yb2*yt2/(sqr(sqr(delta2))*sqr(sqr(delta3))) - 1701.0*sqr(yt2)/(sqr(sqr(delta2))*sqr(sqr(delta3))) + 1458.0*sqr(yb2)/(sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3)))) + 486.0*yb2*ytau2/(sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3)))) + 1458.0*sqr(yt2)/(sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3)))));
a5= f * sqr(lambda) * (sqrt(2*sqr(delta3) - 4)*(-1.4*sqr(sqr(delta2))*sqr(sqr(delta3))*g12*yb2 - 2.6*sqr(sqr(delta2))*sqr(sqr(delta3))*g12*yt2 - 9.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22*yb2 - 9.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22*yt2 - 16.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32*yb2 - 16.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32*yt2 + 51.0*sqr(sqr(delta2))*sqr(sqr(delta3))*sqr(yb2) + 9.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2*ytau2 + 12.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2*yt2 + 51.0*sqr(sqr(delta2))*sqr(sqr(delta3))*sqr(yt2) + 4.2*sqr(sqr(delta2))*sqr(delta3)*g12*yb2 + 7.8*sqr(sqr(delta2))*sqr(delta3)*g12*yt2 + 27.0*sqr(sqr(delta2))*sqr(delta3)*g22*yb2 + 27.0*sqr(sqr(delta2))*sqr(delta3)*g22*yt2 + 48.0*sqr(sqr(delta2))*sqr(delta3)*g32*yb2 + 48.0*sqr(sqr(delta2))*sqr(delta3)*g32*yt2 - 198.0*sqr(sqr(delta2))*sqr(delta3)*sqr(yb2) - 36.0*sqr(sqr(delta2))*sqr(delta3)*yb2*ytau2 - 36.0*sqr(sqr(delta2))*sqr(delta3)*yb2*yt2 - 198.0*sqr(sqr(delta2))*sqr(delta3)*sqr(yt2) + 135.0*sqr(sqr(delta2))*sqr(yb2) + 27.0*sqr(sqr(delta2))*yb2*ytau2 + 135.0*sqr(sqr(delta2))*sqr(yt2) - 1.33226762955019e-15*sqr(delta2)*sqr(sqr(delta3))*g12*yb2 - 162.0*sqr(delta2)*sqr(sqr(delta3))*sqr(yb2) - 36.0*sqr(delta2)*sqr(sqr(delta3))*yb2*ytau2 - 36.0*sqr(delta2)*sqr(sqr(delta3))*yb2*yt2 - 162.0*sqr(delta2)*sqr(sqr(delta3))*sqr(yt2) + 2.66453525910038e-15*sqr(delta2)*sqr(delta3)*g12*yb2 - 1.77635683940025e-15*sqr(delta2)*sqr(delta3)*g12*yt2 + 648.0*sqr(delta2)*sqr(delta3)*sqr(yb2) + 162.0*sqr(delta2)*sqr(delta3)*yb2*ytau2 + 108.0*sqr(delta2)*sqr(delta3)*yb2*yt2 + 648.0*sqr(delta2)*sqr(delta3)*sqr(yt2) - 486.0*sqr(delta2)*sqr(yb2) - 162.0*sqr(delta2)*yb2*ytau2 - 486.0*sqr(delta2)*sqr(yt2) + 1.77635683940025e-15*sqr(sqr(delta3))*g12*yb2 + 243.0*sqr(sqr(delta3))*sqr(yb2) + 54.0*sqr(sqr(delta3))*yb2*ytau2 + 54.0*sqr(sqr(delta3))*yb2*yt2 + 243.0*sqr(sqr(delta3))*sqr(yt2) + 7.105427357601e-15*sqr(delta3)*g12*yb2 - 972.0*sqr(delta3)*sqr(yb2) - 243.0*sqr(delta3)*yb2*ytau2 - 162.0*sqr(delta3)*yb2*yt2 - 972.0*sqr(delta3)*sqr(yt2) + 729.0*sqr(yb2) + 243.0*yb2*ytau2 + 729.0*sqr(yt2))/(sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3)))));
a6= f * sqr(lambda) * (0);
a7= f * sqr(lambda) * (sqrt(2*sqr(delta3) - 4)*(-1.4*sqr(sqr(delta2))*sqr(sqr(delta3))*g12*yb2 - 2.6*sqr(sqr(delta2))*sqr(sqr(delta3))*g12*yt2 - 9.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22*yb2 - 9.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22*yt2 - 16.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32*yb2 - 16.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32*yt2 + 51.0*sqr(sqr(delta2))*sqr(sqr(delta3))*sqr(yb2) + 9.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2*ytau2 + 12.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2*yt2 + 51.0*sqr(sqr(delta2))*sqr(sqr(delta3))*sqr(yt2) + 4.2*sqr(sqr(delta2))*sqr(delta3)*g12*yb2 + 7.8*sqr(sqr(delta2))*sqr(delta3)*g12*yt2 + 27.0*sqr(sqr(delta2))*sqr(delta3)*g22*yb2 + 27.0*sqr(sqr(delta2))*sqr(delta3)*g22*yt2 + 48.0*sqr(sqr(delta2))*sqr(delta3)*g32*yb2 + 48.0*sqr(sqr(delta2))*sqr(delta3)*g32*yt2 - 198.0*sqr(sqr(delta2))*sqr(delta3)*sqr(yb2) - 36.0*sqr(sqr(delta2))*sqr(delta3)*yb2*ytau2 - 36.0*sqr(sqr(delta2))*sqr(delta3)*yb2*yt2 - 198.0*sqr(sqr(delta2))*sqr(delta3)*sqr(yt2) + 135.0*sqr(sqr(delta2))*sqr(yb2) + 27.0*sqr(sqr(delta2))*yb2*ytau2 + 135.0*sqr(sqr(delta2))*sqr(yt2) - 1.33226762955019e-15*sqr(delta2)*sqr(sqr(delta3))*g12*yb2 - 162.0*sqr(delta2)*sqr(sqr(delta3))*sqr(yb2) - 36.0*sqr(delta2)*sqr(sqr(delta3))*yb2*ytau2 - 36.0*sqr(delta2)*sqr(sqr(delta3))*yb2*yt2 - 162.0*sqr(delta2)*sqr(sqr(delta3))*sqr(yt2) + 2.66453525910038e-15*sqr(delta2)*sqr(delta3)*g12*yb2 - 1.77635683940025e-15*sqr(delta2)*sqr(delta3)*g12*yt2 + 648.0*sqr(delta2)*sqr(delta3)*sqr(yb2) + 162.0*sqr(delta2)*sqr(delta3)*yb2*ytau2 + 108.0*sqr(delta2)*sqr(delta3)*yb2*yt2 + 648.0*sqr(delta2)*sqr(delta3)*sqr(yt2) - 486.0*sqr(delta2)*sqr(yb2) - 162.0*sqr(delta2)*yb2*ytau2 - 486.0*sqr(delta2)*sqr(yt2) + 1.77635683940025e-15*sqr(sqr(delta3))*g12*yb2 + 243.0*sqr(sqr(delta3))*sqr(yb2) + 54.0*sqr(sqr(delta3))*yb2*ytau2 + 54.0*sqr(sqr(delta3))*yb2*yt2 + 243.0*sqr(sqr(delta3))*sqr(yt2) + 7.105427357601e-15*sqr(delta3)*g12*yb2 - 972.0*sqr(delta3)*sqr(yb2) - 243.0*sqr(delta3)*yb2*ytau2 - 162.0*sqr(delta3)*yb2*yt2 - 972.0*sqr(delta3)*sqr(yt2) + 729.0*sqr(yb2) + 243.0*yb2*ytau2 + 729.0*sqr(yt2))/(sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3)))));
a8= f * sqr(lambda) * (-0.933333333333333*g12*yb2 - 1.73333333333333*g12*yt2 - 6.0*g22*yb2 - 6.0*g22*yt2 - 10.6666666666667*g32*yb2 - 10.6666666666667*g32*yt2 + 36.0*sqr(yb2) + 8.0*yb2*ytau2 + 8.0*yb2*yt2 + 36.0*sqr(yt2) + 5.6*g12*yb2/sqr(delta3) + 10.4*g12*yt2/sqr(delta3) + 36.0*g22*yb2/sqr(delta3) + 36.0*g22*yt2/sqr(delta3) + 64.0*g32*yb2/sqr(delta3) + 64.0*g32*yt2/sqr(delta3) - 270.0*sqr(yb2)/sqr(delta3) - 54.0*yb2*ytau2/sqr(delta3) - 48.0*yb2*yt2/sqr(delta3) - 270.0*sqr(yt2)/sqr(delta3) - 8.4*g12*yb2/sqr(sqr(delta3)) - 15.6*g12*yt2/sqr(sqr(delta3)) - 54.0*g22*yb2/sqr(sqr(delta3)) - 54.0*g22*yt2/sqr(sqr(delta3)) - 96.0*g32*yb2/sqr(sqr(delta3)) - 96.0*g32*yt2/sqr(sqr(delta3)) + 540.0*sqr(yb2)/sqr(sqr(delta3)) + 108.0*yb2*ytau2/sqr(sqr(delta3)) + 72.0*yb2*yt2/sqr(sqr(delta3)) + 540.0*sqr(yt2)/sqr(sqr(delta3)) - 270.0*sqr(yb2)/(sqr(delta3)*sqr(sqr(delta3))) - 54.0*yb2*ytau2/(sqr(delta3)*sqr(sqr(delta3))) - 270.0*sqr(yt2)/(sqr(delta3)*sqr(sqr(delta3))) - 8.88178419700125e-16*g12*yb2/sqr(delta2) - 120.0*sqr(yb2)/sqr(delta2) - 36.0*yb2*ytau2/sqr(delta2) - 24.0*yb2*yt2/sqr(delta2) - 120.0*sqr(yt2)/sqr(delta2) - 3.5527136788005e-15*g12*yb2/(sqr(delta2)*sqr(delta3)) + 972.0*sqr(yb2)/(sqr(delta2)*sqr(delta3)) + 252.0*yb2*ytau2/(sqr(delta2)*sqr(delta3)) + 144.0*yb2*yt2/(sqr(delta2)*sqr(delta3)) + 972.0*sqr(yt2)/(sqr(delta2)*sqr(delta3)) - 7.105427357601e-15*g12*yb2/(sqr(delta2)*sqr(sqr(delta3))) - 1944.0*sqr(yb2)/(sqr(delta2)*sqr(sqr(delta3))) - 540.0*yb2*ytau2/(sqr(delta2)*sqr(sqr(delta3))) - 216.0*yb2*yt2/(sqr(delta2)*sqr(sqr(delta3))) - 1944.0*sqr(yt2)/(sqr(delta2)*sqr(sqr(delta3))) + 972.0*sqr(yb2)/(sqr(delta2)*(sqr(delta3)*sqr(sqr(delta3)))) + 324.0*yb2*ytau2/(sqr(delta2)*(sqr(delta3)*sqr(sqr(delta3)))) + 972.0*sqr(yt2)/(sqr(delta2)*(sqr(delta3)*sqr(sqr(delta3)))) + 180.0*sqr(yb2)/sqr(sqr(delta2)) + 54.0*yb2*ytau2/sqr(sqr(delta2)) + 36.0*yb2*yt2/sqr(sqr(delta2)) + 180.0*sqr(yt2)/sqr(sqr(delta2)) - 1458.0*sqr(yb2)/(sqr(sqr(delta2))*sqr(delta3)) - 378.0*yb2*ytau2/(sqr(sqr(delta2))*sqr(delta3)) - 216.0*yb2*yt2/(sqr(sqr(delta2))*sqr(delta3)) - 1458.0*sqr(yt2)/(sqr(sqr(delta2))*sqr(delta3)) + 1.4210854715202e-14*g12*yb2/(sqr(sqr(delta2))*sqr(sqr(delta3))) + 2916.0*sqr(yb2)/(sqr(sqr(delta2))*sqr(sqr(delta3))) + 810.0*yb2*ytau2/(sqr(sqr(delta2))*sqr(sqr(delta3))) + 324.0*yb2*yt2/(sqr(sqr(delta2))*sqr(sqr(delta3))) + 2916.0*sqr(yt2)/(sqr(sqr(delta2))*sqr(sqr(delta3))) - 1458.0*sqr(yb2)/(sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3)))) - 486.0*yb2*ytau2/(sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3)))) - 1458.0*sqr(yt2)/(sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3)))));
  ...
  //Ur
a0=f * sqr(lambda) *yt2*(-5.2*sqr(delta2)*sqr(sqr(delta3))*g12 - 18.0*sqr(delta2)*sqr(sqr(delta3))*g22 - 32.0*sqr(delta2)*sqr(sqr(delta3))*g32 + 18.0*sqr(delta2)*sqr(sqr(delta3))*yb2 + 18.0*sqr(delta2)*sqr(sqr(delta3))*yt2 - 72.0*sqr(delta2)*sqr(delta3)*yb2 + 36.0*sqr(delta2)*sqr(delta3)*yt2 + 108.0*sqr(delta2)*yb2 - 54.0*sqr(delta2)*yt2 + 90.0*sqr(sqr(delta3))*yt2 - 324.0*sqr(delta3)*yt2 + 486.0*yt2)/(sqr(sqr(delta2))*sqr(sqr(delta3)));
a1=f * sqr(lambda) *0;
a2=f * sqr(lambda) *0;
a3=f * sqr(lambda) *0;
a4=f * sqr(lambda) *yt2*(-15.6*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 - 54.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 - 96.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32 + 54.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 + 234.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yt2 - 216.0*sqr(sqr(delta2))*sqr(delta3)*yb2 - 540.0*sqr(sqr(delta2))*sqr(delta3)*yt2 + 324.0*sqr(sqr(delta2))*yb2 + 810.0*sqr(sqr(delta2))*yt2 + 31.2*sqr(delta2)*sqr(sqr(delta3))*g12 + 108.0*sqr(delta2)*sqr(sqr(delta3))*g22 + 192.0*sqr(delta2)*sqr(sqr(delta3))*g32 - 108.0*sqr(delta2)*sqr(sqr(delta3))*yb2 - 738.0*sqr(delta2)*sqr(sqr(delta3))*yt2 + 432.0*sqr(delta2)*sqr(delta3)*yb2 + 2052.0*sqr(delta2)*sqr(delta3)*yt2 - 648.0*sqr(delta2)*yb2 - 3078.0*sqr(delta2)*yt2 + 540.0*sqr(sqr(delta3))*yt2 - 1944.0*sqr(delta3)*yt2 + 2916.0*yt2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3)));
a5=f * sqr(lambda) *yt2*sqrt(2*sqr(delta2) - 4)*(-5.2*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 - 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 - 32.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32 + 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 + 96.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yt2 - 72.0*sqr(sqr(delta2))*sqr(delta3)*yb2 - 288.0*sqr(sqr(delta2))*sqr(delta3)*yt2 + 108.0*sqr(sqr(delta2))*yb2 + 432.0*sqr(sqr(delta2))*yt2 + 15.6*sqr(delta2)*sqr(sqr(delta3))*g12 + 54.0*sqr(delta2)*sqr(sqr(delta3))*g22 + 96.0*sqr(delta2)*sqr(sqr(delta3))*g32 - 54.0*sqr(delta2)*sqr(sqr(delta3))*yb2 - 378.0*sqr(delta2)*sqr(sqr(delta3))*yt2 - 3.5527136788005e-15*sqr(delta2)*sqr(delta3)*g12 + 216.0*sqr(delta2)*sqr(delta3)*yb2 + 1188.0*sqr(delta2)*sqr(delta3)*yt2 - 324.0*sqr(delta2)*yb2 - 1782.0*sqr(delta2)*yt2 + 270.0*sqr(sqr(delta3))*yt2 - 972.0*sqr(delta3)*yt2 + 1458.0*yt2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3)));
a6=f * sqr(lambda) *0;
a7=f * sqr(lambda) *yt2*sqrt(2*sqr(delta2) - 4)*(-5.2*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 - 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 - 32.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32 + 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 + 96.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yt2 - 72.0*sqr(sqr(delta2))*sqr(delta3)*yb2 - 288.0*sqr(sqr(delta2))*sqr(delta3)*yt2 + 108.0*sqr(sqr(delta2))*yb2 + 432.0*sqr(sqr(delta2))*yt2 + 15.6*sqr(delta2)*sqr(sqr(delta3))*g12 + 54.0*sqr(delta2)*sqr(sqr(delta3))*g22 + 96.0*sqr(delta2)*sqr(sqr(delta3))*g32 - 54.0*sqr(delta2)*sqr(sqr(delta3))*yb2 - 378.0*sqr(delta2)*sqr(sqr(delta3))*yt2 - 3.5527136788005e-15*sqr(delta2)*sqr(delta3)*g12 + 216.0*sqr(delta2)*sqr(delta3)*yb2 + 1188.0*sqr(delta2)*sqr(delta3)*yt2 - 324.0*sqr(delta2)*yb2 - 1782.0*sqr(delta2)*yt2 + 270.0*sqr(sqr(delta3))*yt2 - 972.0*sqr(delta3)*yt2 + 1458.0*yt2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3)));
a8=f * sqr(lambda) *yt2*(-3.46666666666667*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*g12 - 12.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*g22 - 21.3333333333333*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*g32 + 8.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*yb2 + 72.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*yt2 - 24.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(delta3)*yb2 - 240.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(delta3)*yt2 + 36.0*(sqr(delta2)*sqr(sqr(delta2)))*yb2 + 360.0*(sqr(delta2)*sqr(sqr(delta2)))*yt2 + 20.8*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 + 72.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 + 128.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32 - 72.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 - 516.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yt2 + 288.0*sqr(sqr(delta2))*sqr(delta3)*yb2 + 1800.0*sqr(sqr(delta2))*sqr(delta3)*yt2 - 432.0*sqr(sqr(delta2))*yb2 - 2700.0*sqr(sqr(delta2))*yt2 - 31.2*sqr(delta2)*sqr(sqr(delta3))*g12 - 108.0*sqr(delta2)*sqr(sqr(delta3))*g22 - 192.0*sqr(delta2)*sqr(sqr(delta3))*g32 + 108.0*sqr(delta2)*sqr(sqr(delta3))*yb2 + 1044.0*sqr(delta2)*sqr(sqr(delta3))*yt2 - 432.0*sqr(delta2)*sqr(delta3)*yb2 - 3672.0*sqr(delta2)*sqr(delta3)*yt2 + 648.0*sqr(delta2)*yb2 + 5508.0*sqr(delta2)*yt2 - 540.0*sqr(sqr(delta3))*yt2 + 1944.0*sqr(delta3)*yt2 - 2916.0*yt2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3)));
 ...
 */
  ...
  //Dr
a0= f * sqr(lambda) * (yb2*(-2.8*sqr(delta2)*sqr(sqr(delta3))*g12 - 18.0*sqr(delta2)*sqr(sqr(delta3))*g22 - 32.0*sqr(delta2)*sqr(sqr(delta3))*g32 + 18.0*sqr(delta2)*sqr(sqr(delta3))*yb2 + 18.0*sqr(delta2)*sqr(sqr(delta3))*yt2 - 1.77635683940025e-15*sqr(delta2)*sqr(delta3)*g12 + 36.0*sqr(delta2)*sqr(delta3)*yb2 + 36.0*sqr(delta2)*sqr(delta3)*ytau2 - 72.0*sqr(delta2)*sqr(delta3)*yt2 - 54.0*sqr(delta2)*yb2 - 54.0*sqr(delta2)*ytau2 + 108.0*sqr(delta2)*yt2 + 90.0*sqr(sqr(delta3))*yb2 + 18.0*sqr(sqr(delta3))*ytau2 - 324.0*sqr(delta3)*yb2 - 108.0*sqr(delta3)*ytau2 + 486.0*yb2 + 162.0*ytau2)/(sqr(sqr(delta2))*sqr(sqr(delta3))));
a1= f * sqr(lambda) * (0);
a2= f * sqr(lambda) * (0);
a3= f * sqr(lambda) * (0);
a4= f * sqr(lambda) * (yb2*(-8.4*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 - 54.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 - 96.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32 + 234.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 + 36.0*sqr(sqr(delta2))*sqr(sqr(delta3))*ytau2 + 54.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yt2 - 540.0*sqr(sqr(delta2))*sqr(delta3)*yb2 - 108.0*sqr(sqr(delta2))*sqr(delta3)*ytau2 - 216.0*sqr(sqr(delta2))*sqr(delta3)*yt2 + 810.0*sqr(sqr(delta2))*yb2 + 162.0*sqr(sqr(delta2))*ytau2 + 324.0*sqr(sqr(delta2))*yt2 + 16.8*sqr(delta2)*sqr(sqr(delta3))*g12 + 108.0*sqr(delta2)*sqr(sqr(delta3))*g22 + 192.0*sqr(delta2)*sqr(sqr(delta3))*g32 - 738.0*sqr(delta2)*sqr(sqr(delta3))*yb2 - 126.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 - 108.0*sqr(delta2)*sqr(sqr(delta3))*yt2 + 2052.0*sqr(delta2)*sqr(delta3)*yb2 + 540.0*sqr(delta2)*sqr(delta3)*ytau2 + 432.0*sqr(delta2)*sqr(delta3)*yt2 - 3078.0*sqr(delta2)*yb2 - 810.0*sqr(delta2)*ytau2 - 648.0*sqr(delta2)*yt2 + 540.0*sqr(sqr(delta3))*yb2 + 108.0*sqr(sqr(delta3))*ytau2 - 1944.0*sqr(delta3)*yb2 - 648.0*sqr(delta3)*ytau2 + 2916.0*yb2 + 972.0*ytau2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))));
a5= f * sqr(lambda) * (yb2*sqrt(2*sqr(delta2) - 4)*(-2.8*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 - 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 - 32.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32 + 96.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 + 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*ytau2 + 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yt2 - 2.66453525910038e-15*sqr(sqr(delta2))*sqr(delta3)*g12 - 288.0*sqr(sqr(delta2))*sqr(delta3)*yb2 - 72.0*sqr(sqr(delta2))*sqr(delta3)*ytau2 - 72.0*sqr(sqr(delta2))*sqr(delta3)*yt2 + 3.5527136788005e-15*sqr(sqr(delta2))*g12 + 432.0*sqr(sqr(delta2))*yb2 + 108.0*sqr(sqr(delta2))*ytau2 + 108.0*sqr(sqr(delta2))*yt2 + 8.4*sqr(delta2)*sqr(sqr(delta3))*g12 + 54.0*sqr(delta2)*sqr(sqr(delta3))*g22 + 96.0*sqr(delta2)*sqr(sqr(delta3))*g32 - 378.0*sqr(delta2)*sqr(sqr(delta3))*yb2 - 72.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 - 54.0*sqr(delta2)*sqr(sqr(delta3))*yt2 + 5.32907051820075e-15*sqr(delta2)*sqr(delta3)*g12 + 1188.0*sqr(delta2)*sqr(delta3)*yb2 + 324.0*sqr(delta2)*sqr(delta3)*ytau2 + 216.0*sqr(delta2)*sqr(delta3)*yt2 + 1.4210854715202e-14*sqr(delta2)*g12 - 1782.0*sqr(delta2)*yb2 - 486.0*sqr(delta2)*ytau2 - 324.0*sqr(delta2)*yt2 + 270.0*sqr(sqr(delta3))*yb2 + 54.0*sqr(sqr(delta3))*ytau2 - 972.0*sqr(delta3)*yb2 - 324.0*sqr(delta3)*ytau2 + 1458.0*yb2 + 486.0*ytau2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))));
a6= f * sqr(lambda) * (0);
a7= f * sqr(lambda) * (yb2*sqrt(2*sqr(delta2) - 4)*(-2.8*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 - 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 - 32.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32 + 96.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 + 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*ytau2 + 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yt2 - 2.66453525910038e-15*sqr(sqr(delta2))*sqr(delta3)*g12 - 288.0*sqr(sqr(delta2))*sqr(delta3)*yb2 - 72.0*sqr(sqr(delta2))*sqr(delta3)*ytau2 - 72.0*sqr(sqr(delta2))*sqr(delta3)*yt2 + 3.5527136788005e-15*sqr(sqr(delta2))*g12 + 432.0*sqr(sqr(delta2))*yb2 + 108.0*sqr(sqr(delta2))*ytau2 + 108.0*sqr(sqr(delta2))*yt2 + 8.4*sqr(delta2)*sqr(sqr(delta3))*g12 + 54.0*sqr(delta2)*sqr(sqr(delta3))*g22 + 96.0*sqr(delta2)*sqr(sqr(delta3))*g32 - 378.0*sqr(delta2)*sqr(sqr(delta3))*yb2 - 72.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 - 54.0*sqr(delta2)*sqr(sqr(delta3))*yt2 + 5.32907051820075e-15*sqr(delta2)*sqr(delta3)*g12 + 1188.0*sqr(delta2)*sqr(delta3)*yb2 + 324.0*sqr(delta2)*sqr(delta3)*ytau2 + 216.0*sqr(delta2)*sqr(delta3)*yt2 + 1.4210854715202e-14*sqr(delta2)*g12 - 1782.0*sqr(delta2)*yb2 - 486.0*sqr(delta2)*ytau2 - 324.0*sqr(delta2)*yt2 + 270.0*sqr(sqr(delta3))*yb2 + 54.0*sqr(sqr(delta3))*ytau2 - 972.0*sqr(delta3)*yb2 - 324.0*sqr(delta3)*ytau2 + 1458.0*yb2 + 486.0*ytau2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))));
a8= f * sqr(lambda) * (yb2*(-1.86666666666667*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*g12 - 12.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*g22 - 21.3333333333333*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*g32 + 72.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*yb2 + 16.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*ytau2 + 8.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*yt2 - 1.77635683940025e-15*(sqr(delta2)*sqr(sqr(delta2)))*sqr(delta3)*g12 - 240.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(delta3)*yb2 - 72.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(delta3)*ytau2 - 24.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(delta3)*yt2 + 360.0*(sqr(delta2)*sqr(sqr(delta2)))*yb2 + 108.0*(sqr(delta2)*sqr(sqr(delta2)))*ytau2 + 36.0*(sqr(delta2)*sqr(sqr(delta2)))*yt2 + 11.2*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 + 72.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 + 128.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32 - 516.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 - 108.0*sqr(sqr(delta2))*sqr(sqr(delta3))*ytau2 - 72.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yt2 - 7.105427357601e-15*sqr(sqr(delta2))*sqr(delta3)*g12 + 1800.0*sqr(sqr(delta2))*sqr(delta3)*yb2 + 504.0*sqr(sqr(delta2))*sqr(delta3)*ytau2 + 288.0*sqr(sqr(delta2))*sqr(delta3)*yt2 - 2700.0*sqr(sqr(delta2))*yb2 - 756.0*sqr(sqr(delta2))*ytau2 - 432.0*sqr(sqr(delta2))*yt2 - 16.8*sqr(delta2)*sqr(sqr(delta3))*g12 - 108.0*sqr(delta2)*sqr(sqr(delta3))*g22 - 192.0*sqr(delta2)*sqr(sqr(delta3))*g32 + 1044.0*sqr(delta2)*sqr(sqr(delta3))*yb2 + 216.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 + 108.0*sqr(delta2)*sqr(sqr(delta3))*yt2 - 1.4210854715202e-14*sqr(delta2)*sqr(delta3)*g12 - 3672.0*sqr(delta2)*sqr(delta3)*yb2 - 1080.0*sqr(delta2)*sqr(delta3)*ytau2 - 432.0*sqr(delta2)*sqr(delta3)*yt2 + 2.8421709430404e-14*sqr(delta2)*g12 + 5508.0*sqr(delta2)*yb2 + 1620.0*sqr(delta2)*ytau2 + 648.0*sqr(delta2)*yt2 - 540.0*sqr(sqr(delta3))*yb2 - 108.0*sqr(sqr(delta3))*ytau2 + 1944.0*sqr(delta3)*yb2 + 648.0*sqr(delta3)*ytau2 - 2916.0*yb2 - 972.0*ytau2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))));
  ...
  //Ll
a0=f * sqr(lambda) *ytau2*(-5.4*sqr(sqr(delta2))*sqr(delta3)*g12 - 9.0*sqr(sqr(delta2))*sqr(delta3)*g22 + 12.0*sqr(sqr(delta2))*sqr(delta3)*ytau2 + 27.0*sqr(sqr(delta2))*yb2 + 27.0*sqr(sqr(delta2))*ytau2 + 3.5527136788005e-15*sqr(delta2)*sqr(delta3)*g12 + 54.0*sqr(delta2)*sqr(delta3)*yb2 - 36.0*sqr(delta2)*sqr(delta3)*ytau2 - 162.0*sqr(delta2)*yb2 - 54.0*sqr(delta2)*ytau2 - 81.0*sqr(delta3)*yb2 + 54.0*sqr(delta3)*ytau2 + 243.0*yb2 + 81.0*ytau2)/(sqr(sqr(delta2))*sqr(sqr(delta3)));
a1=f * sqr(lambda) *0;
a2=f * sqr(lambda) *0;
a3=f * sqr(lambda) *0;
a4=f * sqr(lambda) *ytau2*(-16.2*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 - 27.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 + 54.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 + 90.0*sqr(sqr(delta2))*sqr(sqr(delta3))*ytau2 + 32.4*sqr(sqr(delta2))*sqr(delta3)*g12 + 54.0*sqr(sqr(delta2))*sqr(delta3)*g22 - 189.0*sqr(sqr(delta2))*sqr(delta3)*yb2 - 261.0*sqr(sqr(delta2))*sqr(delta3)*ytau2 + 162.0*sqr(sqr(delta2))*yb2 + 162.0*sqr(sqr(delta2))*ytau2 - 162.0*sqr(delta2)*sqr(sqr(delta3))*yb2 - 216.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 + 810.0*sqr(delta2)*sqr(delta3)*yb2 + 594.0*sqr(delta2)*sqr(delta3)*ytau2 - 972.0*sqr(delta2)*yb2 - 324.0*sqr(delta2)*ytau2 + 243.0*sqr(sqr(delta3))*yb2 + 324.0*sqr(sqr(delta3))*ytau2 - 1215.0*sqr(delta3)*yb2 - 891.0*sqr(delta3)*ytau2 + 1458.0*yb2 + 486.0*ytau2)/(sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3))));
a5=f * sqr(lambda) *ytau2*sqrt(2*sqr(delta3) - 4)*(-5.4*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 - 9.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 + 27.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 + 33.0*sqr(sqr(delta2))*sqr(sqr(delta3))*ytau2 + 16.2*sqr(sqr(delta2))*sqr(delta3)*g12 + 27.0*sqr(sqr(delta2))*sqr(delta3)*g22 - 108.0*sqr(sqr(delta2))*sqr(delta3)*yb2 - 126.0*sqr(sqr(delta2))*sqr(delta3)*ytau2 + 81.0*sqr(sqr(delta2))*yb2 + 81.0*sqr(sqr(delta2))*ytau2 + 5.32907051820083e-15*sqr(delta2)*sqr(sqr(delta3))*g12 - 108.0*sqr(delta2)*sqr(sqr(delta3))*yb2 - 90.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 - 1.06581410364015e-14*sqr(delta2)*sqr(delta3)*g12 + 486.0*sqr(delta2)*sqr(delta3)*yb2 + 324.0*sqr(delta2)*sqr(delta3)*ytau2 - 486.0*sqr(delta2)*yb2 - 162.0*sqr(delta2)*ytau2 - 7.105427357601e-15*sqr(sqr(delta3))*g12 + 162.0*sqr(sqr(delta3))*yb2 + 135.0*sqr(sqr(delta3))*ytau2 - 2.8421709430404e-14*sqr(delta3)*g12 - 729.0*sqr(delta3)*yb2 - 486.0*sqr(delta3)*ytau2 + 729.0*yb2 + 243.0*ytau2)/(sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3))));
a6=f * sqr(lambda) *0;
a7=f * sqr(lambda) *ytau2*sqrt(2*sqr(delta3) - 4)*(-5.4*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 - 9.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 + 27.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 + 33.0*sqr(sqr(delta2))*sqr(sqr(delta3))*ytau2 + 16.2*sqr(sqr(delta2))*sqr(delta3)*g12 + 27.0*sqr(sqr(delta2))*sqr(delta3)*g22 - 108.0*sqr(sqr(delta2))*sqr(delta3)*yb2 - 126.0*sqr(sqr(delta2))*sqr(delta3)*ytau2 + 81.0*sqr(sqr(delta2))*yb2 + 81.0*sqr(sqr(delta2))*ytau2 + 5.32907051820083e-15*sqr(delta2)*sqr(sqr(delta3))*g12 - 108.0*sqr(delta2)*sqr(sqr(delta3))*yb2 - 90.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 - 1.06581410364015e-14*sqr(delta2)*sqr(delta3)*g12 + 486.0*sqr(delta2)*sqr(delta3)*yb2 + 324.0*sqr(delta2)*sqr(delta3)*ytau2 - 486.0*sqr(delta2)*yb2 - 162.0*sqr(delta2)*ytau2 - 7.105427357601e-15*sqr(sqr(delta3))*g12 + 162.0*sqr(sqr(delta3))*yb2 + 135.0*sqr(sqr(delta3))*ytau2 - 2.8421709430404e-14*sqr(delta3)*g12 - 729.0*sqr(delta3)*yb2 - 486.0*sqr(delta3)*ytau2 + 729.0*yb2 + 243.0*ytau2)/(sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3))));
a8=f * sqr(lambda) *ytau2*(-3.6*sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3)))*g12 - 6.0*sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3)))*g22 + 24.0*sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3)))*yb2 + 20.0*sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3)))*ytau2 + 21.6*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 + 36.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 - 162.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 - 162.0*sqr(sqr(delta2))*sqr(sqr(delta3))*ytau2 - 32.4*sqr(sqr(delta2))*sqr(delta3)*g12 - 54.0*sqr(sqr(delta2))*sqr(delta3)*g22 + 324.0*sqr(sqr(delta2))*sqr(delta3)*yb2 + 324.0*sqr(sqr(delta2))*sqr(delta3)*ytau2 - 162.0*sqr(sqr(delta2))*yb2 - 162.0*sqr(sqr(delta2))*ytau2 + 3.5527136788005e-15*sqr(delta2)*(sqr(delta3)*sqr(sqr(delta3)))*g12 - 108.0*sqr(delta2)*(sqr(delta3)*sqr(sqr(delta3)))*yb2 - 48.0*sqr(delta2)*(sqr(delta3)*sqr(sqr(delta3)))*ytau2 + 1.4210854715202e-14*sqr(delta2)*sqr(sqr(delta3))*g12 + 756.0*sqr(delta2)*sqr(sqr(delta3))*yb2 + 468.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 + 2.8421709430404e-14*sqr(delta2)*sqr(delta3)*g12 - 1620.0*sqr(delta2)*sqr(delta3)*yb2 - 864.0*sqr(delta2)*sqr(delta3)*ytau2 + 972.0*sqr(delta2)*yb2 + 324.0*sqr(delta2)*ytau2 + 162.0*(sqr(delta3)*sqr(sqr(delta3)))*yb2 + 72.0*(sqr(delta3)*sqr(sqr(delta3)))*ytau2 - 1134.0*sqr(sqr(delta3))*yb2 - 702.0*sqr(sqr(delta3))*ytau2 - 5.6843418860808e-14*sqr(delta3)*g12 + 2430.0*sqr(delta3)*yb2 + 1296.0*sqr(delta3)*ytau2 - 1458.0*yb2 - 486.0*ytau2)/(sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3))));
  ...
  //Er
a0=f * sqr(lambda) *ytau2*(-10.8*sqr(delta2)*sqr(sqr(delta3))*g12 - 18.0*sqr(delta2)*sqr(sqr(delta3))*g22 + 18.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 + 7.105427357601e-15*sqr(delta2)*sqr(delta3)*g12 + 108.0*sqr(delta2)*sqr(delta3)*yb2 - 36.0*sqr(delta2)*sqr(delta3)*ytau2 - 162.0*sqr(delta2)*yb2 + 54.0*sqr(delta2)*ytau2 + 54.0*sqr(sqr(delta3))*yb2 + 54.0*sqr(sqr(delta3))*ytau2 - 324.0*sqr(delta3)*yb2 - 108.0*sqr(delta3)*ytau2 + 486.0*yb2 + 162.0*ytau2)/(sqr(sqr(delta2))*sqr(sqr(delta3)));
a1=f * sqr(lambda) *0;
a2=f * sqr(lambda) *0;
a3=f * sqr(lambda) *0;
a4=f * sqr(lambda) *ytau2*(-32.4*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 - 54.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 + 108.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 + 162.0*sqr(sqr(delta2))*sqr(sqr(delta3))*ytau2 - 324.0*sqr(sqr(delta2))*sqr(delta3)*yb2 - 324.0*sqr(sqr(delta2))*sqr(delta3)*ytau2 + 486.0*sqr(sqr(delta2))*yb2 + 486.0*sqr(sqr(delta2))*ytau2 + 64.8*sqr(delta2)*sqr(sqr(delta3))*g12 + 108.0*sqr(delta2)*sqr(sqr(delta3))*g22 - 378.0*sqr(delta2)*sqr(sqr(delta3))*yb2 - 486.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 + 1620.0*sqr(delta2)*sqr(delta3)*yb2 + 972.0*sqr(delta2)*sqr(delta3)*ytau2 - 2430.0*sqr(delta2)*yb2 - 1458.0*sqr(delta2)*ytau2 + 324.0*sqr(sqr(delta3))*yb2 + 324.0*sqr(sqr(delta3))*ytau2 - 1944.0*sqr(delta3)*yb2 - 648.0*sqr(delta3)*ytau2 + 2916.0*yb2 + 972.0*ytau2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3)));
a5=f * sqr(lambda) *ytau2*sqrt(2*sqr(delta2) - 4)*(-10.8*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 - 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 + 54.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 + 60.0*sqr(sqr(delta2))*sqr(sqr(delta3))*ytau2 + 1.06581410364017e-14*sqr(sqr(delta2))*sqr(delta3)*g12 - 216.0*sqr(sqr(delta2))*sqr(delta3)*yb2 - 144.0*sqr(sqr(delta2))*sqr(delta3)*ytau2 - 1.4210854715202e-14*sqr(sqr(delta2))*g12 + 324.0*sqr(sqr(delta2))*yb2 + 216.0*sqr(sqr(delta2))*ytau2 + 32.4*sqr(delta2)*sqr(sqr(delta3))*g12 + 54.0*sqr(delta2)*sqr(sqr(delta3))*g22 - 216.0*sqr(delta2)*sqr(sqr(delta3))*yb2 - 234.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 - 2.1316282072803e-14*sqr(delta2)*sqr(delta3)*g12 + 972.0*sqr(delta2)*sqr(delta3)*yb2 + 540.0*sqr(delta2)*sqr(delta3)*ytau2 - 5.6843418860808e-14*sqr(delta2)*g12 - 1458.0*sqr(delta2)*yb2 - 810.0*sqr(delta2)*ytau2 + 162.0*sqr(sqr(delta3))*yb2 + 162.0*sqr(sqr(delta3))*ytau2 - 972.0*sqr(delta3)*yb2 - 324.0*sqr(delta3)*ytau2 + 1458.0*yb2 + 486.0*ytau2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3)));
a6=f * sqr(lambda) *0;
a7=f * sqr(lambda) *ytau2*sqrt(2*sqr(delta2) - 4)*(-10.8*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 - 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 + 54.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 + 60.0*sqr(sqr(delta2))*sqr(sqr(delta3))*ytau2 + 1.06581410364017e-14*sqr(sqr(delta2))*sqr(delta3)*g12 - 216.0*sqr(sqr(delta2))*sqr(delta3)*yb2 - 144.0*sqr(sqr(delta2))*sqr(delta3)*ytau2 - 1.4210854715202e-14*sqr(sqr(delta2))*g12 + 324.0*sqr(sqr(delta2))*yb2 + 216.0*sqr(sqr(delta2))*ytau2 + 32.4*sqr(delta2)*sqr(sqr(delta3))*g12 + 54.0*sqr(delta2)*sqr(sqr(delta3))*g22 - 216.0*sqr(delta2)*sqr(sqr(delta3))*yb2 - 234.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 - 2.1316282072803e-14*sqr(delta2)*sqr(delta3)*g12 + 972.0*sqr(delta2)*sqr(delta3)*yb2 + 540.0*sqr(delta2)*sqr(delta3)*ytau2 - 5.6843418860808e-14*sqr(delta2)*g12 - 1458.0*sqr(delta2)*yb2 - 810.0*sqr(delta2)*ytau2 + 162.0*sqr(sqr(delta3))*yb2 + 162.0*sqr(sqr(delta3))*ytau2 - 972.0*sqr(delta3)*yb2 - 324.0*sqr(delta3)*ytau2 + 1458.0*yb2 + 486.0*ytau2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3)));
a8=f * sqr(lambda) *ytau2*(-7.2*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*g12 - 12.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*g22 + 48.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*yb2 + 40.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*ytau2 + 7.105427357601e-15*(sqr(delta2)*sqr(sqr(delta2)))*sqr(delta3)*g12 - 216.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(delta3)*yb2 - 96.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(delta3)*ytau2 + 324.0*(sqr(delta2)*sqr(sqr(delta2)))*yb2 + 144.0*(sqr(delta2)*sqr(sqr(delta2)))*ytau2 + 43.2*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 + 72.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 - 324.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 - 300.0*sqr(sqr(delta2))*sqr(sqr(delta3))*ytau2 + 2.8421709430404e-14*sqr(sqr(delta2))*sqr(delta3)*g12 + 1512.0*sqr(sqr(delta2))*sqr(delta3)*yb2 + 792.0*sqr(sqr(delta2))*sqr(delta3)*ytau2 - 2268.0*sqr(sqr(delta2))*yb2 - 1188.0*sqr(sqr(delta2))*ytau2 - 64.8*sqr(delta2)*sqr(sqr(delta3))*g12 - 108.0*sqr(delta2)*sqr(sqr(delta3))*g22 + 648.0*sqr(delta2)*sqr(sqr(delta3))*yb2 + 612.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 + 5.6843418860808e-14*sqr(delta2)*sqr(delta3)*g12 - 3240.0*sqr(delta2)*sqr(delta3)*yb2 - 1512.0*sqr(delta2)*sqr(delta3)*ytau2 - 1.13686837721616e-13*sqr(delta2)*g12 + 4860.0*sqr(delta2)*yb2 + 2268.0*sqr(delta2)*ytau2 - 324.0*sqr(sqr(delta3))*yb2 - 324.0*sqr(sqr(delta3))*ytau2 + 1944.0*sqr(delta3)*yb2 + 648.0*sqr(delta3)*ytau2 - 2916.0*yb2 - 972.0*ytau2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3)));
  ...
  //higgs masses
  double deltaHu = - f * sqr(lambda) * (6*yb2*yt2 + 18*sqr(yt2) - 36*yb2*yt2/sqr(delta3) - 36*sqr(yt2)/sqr(delta3) + 54*yb2*yt2/sqr(sqr(delta3)) + 54*sqr(yt2)/sqr(sqr(delta3)) - 72*sqr(yt2)/sqr(delta2) + 108*sqr(yt2)/sqr(sqr(delta2)));
  
  double deltaHd = - f * sqr(lambda) *(3*(3*sqr(delta3)*sqr(sqr(delta2) - 3.0)*(2*sqr(yb2) + sqr(ytau2)) + 9*sqr(sqr(delta2) - 3)*(sqr(delta3) - 2)*(2*sqr(yb2) + sqr(ytau2)) + 2*(2*sqr(yb2) + sqr(ytau2))*sqr(sqr(delta2)*sqr(delta3) - 3*sqr(delta2) - 3*sqr(delta3) + 9) + (sqr(yb2) + yb2*yt2 + sqr(ytau2))*(12*sqr(delta2)*sqr(0.5*sqr(delta3) - 1.5) + 9*(sqr(delta2) - 2)*sqr(sqr(delta3) - 3) + 2*sqr(sqr(delta2)*sqr(delta3) - 3*sqr(delta2) - 3*sqr(delta3) + 9)))/(sqr(sqr(delta2))*sqr(sqr(delta3))));
  ...
  if(beta3 == 0)
  {
  	setTrilinearElement(UA, 2, 3, 0);
  	setTrilinearElement(DA, 2, 3, 0);
  	setTrilinearElement(EA, 2, 3, 0);
  }
  else
  {
  	setTrilinearElement(UA, 2, 3, -lambda * 3*yt*sqrt(2*sqr(delta3) - 4)*(sqr(delta3)*yb2 + sqr(delta3)*yt2 - 3*yb2 - 3*yt2)/sqr(sqr(delta3)) * beta3 / sqrt(sqr(beta3)));
  	setTrilinearElement(DA, 2, 3, -lambda * yb * 3 * sqrt(2*sqr(delta3) - 4)*(sqr(delta3)*yb2 + sqr(delta3)*yt2 - 3*yb2 - 3*yt2)/sqr(sqr(delta3)) * beta3 / sqrt(sqr(beta3)));
  	setTrilinearElement(EA, 2, 3, -lambda * ytau * ytau2  * (sqrt(2*sqr(delta3) - 4)*(3*sqr(delta3) - 9)/sqr(sqr(delta3))) * beta3 / sqrt(sqr(beta3)));
  }
  if(beta2 ==0)
  {
  	setTrilinearElement(UA, 3, 2, 0);
  	setTrilinearElement(DA, 3, 2, 0);
  	setTrilinearElement(EA, 3, 2, 0);  
  }
  else
  {
  	setTrilinearElement(UA, 3, 2, -lambda * yt * yt2 *sqrt(2*sqr(delta2) - 4)*(6*sqr(delta2) - 18)/sqr(sqr(delta2))* beta2 / sqrt(sqr(beta2)));
  	setTrilinearElement(DA, 3, 2, -lambda * yb * yb2 *sqrt(2*sqr(delta2) - 4)*(6*sqr(delta2) - 18)/sqr(sqr(delta2)) * beta2 / sqrt(sqr(beta2)));
  	setTrilinearElement(EA, 3, 2, -lambda * ytau * ytau2  * (sqrt(2*sqr(delta2) - 4)*(6*sqr(delta2) - 18)/sqr(sqr(delta2))) * beta2 / sqrt(sqr(beta2)));
  }
  //
  
  double UA3 = 2.*yb2 + 6.*yt2 - 12.*yb2/sqr(delta3) - 12.*yt2/sqr(delta3) + 18.*yb2/sqr(sqr(delta3)) + 18.*yt2/sqr(sqr(delta3)) - 24.*yt2/sqr(delta2) + 36.*yt2/sqr(sqr(delta2));
  
  setTrilinearElement(UA, 3, 3, -lambda * yt * UA3);
  
  
  double UD3 = 6*yb2 + 2*yt2 - 12*yb2/sqr(delta3) - 12*yt2/sqr(delta3) + 18*yb2/sqr(sqr(delta3)) + 18*yt2/sqr(sqr(delta3)) - 24*yb2/sqr(delta2) + 36*yb2/sqr(sqr(delta2));
  
  setTrilinearElement(DA, 3, 3, -lambda * yb * UD3);
  
  
  double EA3 = 6.0 - 12.0/sqr(delta3) + 18.0/sqr(sqr(delta3)) - 24.0/sqr(delta2) + 36.0/sqr(sqr(delta2));
  //
...
void MssmSoftPars::FGMCaseB2(const MssmSusy & xx, double LAMBDA, 
			       double mMess, double beta2, double beta3, double cgrav) {
...
a1= f * sqr(lambda) * (sqrt(2)*beta3*(-0.375*sqr(yb2) + 0.75*yb2*yt2 - 0.375*sqr(yt2)));
a2= f * sqr(lambda) * (0);
a3= f * sqr(lambda) * (sqrt(2)*beta3*(-0.375*sqr(yb2) + 0.75*yb2*yt2 - 0.375*sqr(yt2)));
a4= f * sqr(lambda) * (0);
a5= f * sqr(lambda) * (0);
a6= f * sqr(lambda) * (0);
a7= f * sqr(lambda) * (0);
...
a1= f * sqr(lambda) * (-0.375*sqrt(2)*beta3*sqr(ytau2));
a2= f * sqr(lambda) * (0);
a3= f * sqr(lambda) * (-0.375*sqrt(2)*beta3*sqr(ytau2));
a4= f * sqr(lambda) * (0);
a5= f * sqr(lambda) * (0);
a6= f * sqr(lambda) * (0);
a7= f * sqr(lambda) * (0);
...
a8= f * sqr(lambda) * (ytau2*(-1.8*g12 - 3.0*g22 + 4.125*yb2 + 2.875*ytau2));
  ...
  setTrilinearElement(UA, 1, 1, -lambda * 0.75 * sqrt(2) * beta2 * yt * (yt2+yb2));
  setTrilinearElement(UA, 2, 2, -lambda * 1.5 * sqrt(2) * beta2 * yt * yt2);
  setTrilinearElement(UA, 3, 3, -lambda * yt * (1.5*yt2 + 0.5*yb2));
  
  setTrilinearElement(DA, 1, 1, -lambda * 0.75 * sqrt(2) * beta2 * yb * (yb2+yt2));
  setTrilinearElement(DA, 2, 2, -lambda * 1.5 * sqrt(2) * beta2 * yb * yb2);
  setTrilinearElement(DA, 3, 3, -lambda * yb * (1.5*yb2 + 0.5*yt2));
  
  setTrilinearElement(EA, 1, 1, -lambda * 0.75 * sqrt(2) * beta2 * ytau * ytau2);
  setTrilinearElement(EA, 2, 2, -lambda * 1.5 * sqrt(2) * beta2 * ytau * ytau2);
  setTrilinearElement(EA, 3, 3, -lambda * 1.5 * ytau * ytau2);
  
}

void MssmSoftPars::FGMCaseB1Alt(const MssmSusy & xx, double LAMBDA, 
			       double mMess, double beta2, double beta3, double cgrav) {
  ...
  //Ql
a0= f * sqr(lambda) * (-4.2*g12*yb2/sqr(delta3) - 7.8*g12*yt2/sqr(delta3) - 27.0*g22*yb2/sqr(delta3) - 27.0*g22*yt2/sqr(delta3) - 48.0*g32*yb2/sqr(delta3) - 48.0*g32*yt2/sqr(delta3) + 126.0*sqr(yb2)/sqr(delta3) + 18.0*yb2*ytau2/sqr(delta3) + 36.0*yb2*yt2/sqr(delta3) + 126.0*sqr(yt2)/sqr(delta3) + 8.4*g12*yb2/sqr(sqr(delta3)) + 15.6*g12*yt2/sqr(sqr(delta3)) + 54.0*g22*yb2/sqr(sqr(delta3)) + 54.0*g22*yt2/sqr(sqr(delta3)) + 96.0*g32*yb2/sqr(sqr(delta3)) + 96.0*g32*yt2/sqr(sqr(delta3)) - 387.0*sqr(yb2)/sqr(sqr(delta3)) - 63.0*yb2*ytau2/sqr(sqr(delta3)) - 72.0*yb2*yt2/sqr(sqr(delta3)) - 387.0*sqr(yt2)/sqr(sqr(delta3)) + 270.0*sqr(yb2)/(sqr(delta3)*sqr(sqr(delta3))) + 54.0*yb2*ytau2/(sqr(delta3)*sqr(sqr(delta3))) + 270.0*sqr(yt2)/(sqr(delta3)*sqr(sqr(delta3))) - 2.66453525910038e-15*g12*yb2/(sqr(delta2)*sqr(delta3)) - 1.77635683940025e-15*g12*yt2/(sqr(delta2)*sqr(delta3)) - 324.0*sqr(yb2)/(sqr(delta2)*sqr(delta3)) - 54.0*yb2*ytau2/(sqr(delta2)*sqr(delta3)) - 108.0*yb2*yt2/(sqr(delta2)*sqr(delta3)) - 324.0*sqr(yt2)/(sqr(delta2)*sqr(delta3)) + 5.32907051820083e-15*g12*yb2/(sqr(delta2)*sqr(sqr(delta3))) + 3.5527136788005e-15*g12*yt2/(sqr(delta2)*sqr(sqr(delta3))) + 1134.0*sqr(yb2)/(sqr(delta2)*sqr(sqr(delta3))) + 270.0*yb2*ytau2/(sqr(delta2)*sqr(sqr(delta3))) + 216.0*yb2*yt2/(sqr(delta2)*sqr(sqr(delta3))) + 1134.0*sqr(yt2)/(sqr(delta2)*sqr(sqr(delta3))) - 972.0*sqr(yb2)/(sqr(delta2)*(sqr(delta3)*sqr(sqr(delta3)))) - 324.0*yb2*ytau2/(sqr(delta2)*(sqr(delta3)*sqr(sqr(delta3)))) - 972.0*sqr(yt2)/(sqr(delta2)*(sqr(delta3)*sqr(sqr(delta3)))) + 486.0*sqr(yb2)/(sqr(sqr(delta2))*sqr(delta3)) + 81.0*yb2*ytau2/(sqr(sqr(delta2))*sqr(delta3)) + 162.0*yb2*yt2/(sqr(sqr(delta2))*sqr(delta3)) + 486.0*sqr(yt2)/(sqr(sqr(delta2))*sqr(delta3)) - 1701.0*sqr(yb2)/(sqr(sqr(delta2))*sqr(sqr(delta3))) - 405.0*yb2*ytau2/(sqr(sqr(delta2))*sqr(sqr(delta3))) - 324.0*yb2*yt2/(sqr(sqr(delta2))*sqr(sqr(delta3))) - 1701.0*sqr(yt2)/(sqr(sqr(delta2))*sqr(sqr(delta3))) + 1458.0*sqr(yb2)/(sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3)))) + 486.0*yb2*ytau2/(sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3)))) + 1458.0*sqr(yt2)/(sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3)))));
a1= f * sqr(lambda) * (0);
a2= f * sqr(lambda) * (sqrt(2*sqr(delta3) - 4)*(-1.4*sqr(sqr(delta2))*sqr(sqr(delta3))*g12*yb2 - 2.6*sqr(sqr(delta2))*sqr(sqr(delta3))*g12*yt2 - 9.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22*yb2 - 9.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22*yt2 - 16.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32*yb2 - 16.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32*yt2 + 51.0*sqr(sqr(delta2))*sqr(sqr(delta3))*sqr(yb2) + 9.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2*ytau2 + 12.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2*yt2 + 51.0*sqr(sqr(delta2))*sqr(sqr(delta3))*sqr(yt2) + 4.2*sqr(sqr(delta2))*sqr(delta3)*g12*yb2 + 7.8*sqr(sqr(delta2))*sqr(delta3)*g12*yt2 + 27.0*sqr(sqr(delta2))*sqr(delta3)*g22*yb2 + 27.0*sqr(sqr(delta2))*sqr(delta3)*g22*yt2 + 48.0*sqr(sqr(delta2))*sqr(delta3)*g32*yb2 + 48.0*sqr(sqr(delta2))*sqr(delta3)*g32*yt2 - 198.0*sqr(sqr(delta2))*sqr(delta3)*sqr(yb2) - 36.0*sqr(sqr(delta2))*sqr(delta3)*yb2*ytau2 - 36.0*sqr(sqr(delta2))*sqr(delta3)*yb2*yt2 - 198.0*sqr(sqr(delta2))*sqr(delta3)*sqr(yt2) + 135.0*sqr(sqr(delta2))*sqr(yb2) + 27.0*sqr(sqr(delta2))*yb2*ytau2 + 135.0*sqr(sqr(delta2))*sqr(yt2) - 1.33226762955019e-15*sqr(delta2)*sqr(sqr(delta3))*g12*yb2 - 162.0*sqr(delta2)*sqr(sqr(delta3))*sqr(yb2) - 36.0*sqr(delta2)*sqr(sqr(delta3))*yb2*ytau2 - 36.0*sqr(delta2)*sqr(sqr(delta3))*yb2*yt2 - 162.0*sqr(delta2)*sqr(sqr(delta3))*sqr(yt2) + 2.66453525910038e-15*sqr(delta2)*sqr(delta3)*g12*yb2 - 1.77635683940025e-15*sqr(delta2)*sqr(delta3)*g12*yt2 + 648.0*sqr(delta2)*sqr(delta3)*sqr(yb2) + 162.0*sqr(delta2)*sqr(delta3)*yb2*ytau2 + 108.0*sqr(delta2)*sqr(delta3)*yb2*yt2 + 648.0*sqr(delta2)*sqr(delta3)*sqr(yt2) - 486.0*sqr(delta2)*sqr(yb2) - 162.0*sqr(delta2)*yb2*ytau2 - 486.0*sqr(delta2)*sqr(yt2) + 1.77635683940025e-15*sqr(sqr(delta3))*g12*yb2 + 243.0*sqr(sqr(delta3))*sqr(yb2) + 54.0*sqr(sqr(delta3))*yb2*ytau2 + 54.0*sqr(sqr(delta3))*yb2*yt2 + 243.0*sqr(sqr(delta3))*sqr(yt2) + 7.105427357601e-15*sqr(delta3)*g12*yb2 - 972.0*sqr(delta3)*sqr(yb2) - 243.0*sqr(delta3)*yb2*ytau2 - 162.0*sqr(delta3)*yb2*yt2 - 972.0*sqr(delta3)*sqr(yt2) + 729.0*sqr(yb2) + 243.0*yb2*ytau2 + 729.0*sqr(yt2))/(sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3)))));
a3= f * sqr(lambda) * (0);
a4= f * sqr(lambda) * ((-1.4*sqr(sqr(delta2))*sqr(delta3)*g12*yb2 - 2.6*sqr(sqr(delta2))*sqr(delta3)*g12*yt2 - 9.0*sqr(sqr(delta2))*sqr(delta3)*g22*yb2 - 9.0*sqr(sqr(delta2))*sqr(delta3)*g22*yt2 - 16.0*sqr(sqr(delta2))*sqr(delta3)*g32*yb2 - 16.0*sqr(sqr(delta2))*sqr(delta3)*g32*yt2 + 12.0*sqr(sqr(delta2))*sqr(delta3)*sqr(yb2) + 12.0*sqr(sqr(delta2))*sqr(delta3)*yb2*yt2 + 12.0*sqr(sqr(delta2))*sqr(delta3)*sqr(yt2) + 45.0*sqr(sqr(delta2))*sqr(yb2) + 9.0*sqr(sqr(delta2))*yb2*ytau2 + 45.0*sqr(sqr(delta2))*sqr(yt2) - 8.88178419700125e-16*sqr(delta2)*sqr(delta3)*g12*yb2 + 18.0*sqr(delta2)*sqr(delta3)*yb2*ytau2 - 36.0*sqr(delta2)*sqr(delta3)*yb2*yt2 - 162.0*sqr(delta2)*sqr(yb2) - 54.0*sqr(delta2)*yb2*ytau2 - 162.0*sqr(delta2)*sqr(yt2) - 27.0*sqr(delta3)*yb2*ytau2 + 54.0*sqr(delta3)*yb2*yt2 + 243.0*sqr(yb2) + 81.0*yb2*ytau2 + 243.0*sqr(yt2))/(sqr(sqr(delta2))*sqr(sqr(delta3))));
a5= f * sqr(lambda) * (0);
a6= f * sqr(lambda) * (sqrt(2*sqr(delta3) - 4)*(-1.4*sqr(sqr(delta2))*sqr(sqr(delta3))*g12*yb2 - 2.6*sqr(sqr(delta2))*sqr(sqr(delta3))*g12*yt2 - 9.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22*yb2 - 9.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22*yt2 - 16.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32*yb2 - 16.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32*yt2 + 51.0*sqr(sqr(delta2))*sqr(sqr(delta3))*sqr(yb2) + 9.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2*ytau2 + 12.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2*yt2 + 51.0*sqr(sqr(delta2))*sqr(sqr(delta3))*sqr(yt2) + 4.2*sqr(sqr(delta2))*sqr(delta3)*g12*yb2 + 7.8*sqr(sqr(delta2))*sqr(delta3)*g12*yt2 + 27.0*sqr(sqr(delta2))*sqr(delta3)*g22*yb2 + 27.0*sqr(sqr(delta2))*sqr(delta3)*g22*yt2 + 48.0*sqr(sqr(delta2))*sqr(delta3)*g32*yb2 + 48.0*sqr(sqr(delta2))*sqr(delta3)*g32*yt2 - 198.0*sqr(sqr(delta2))*sqr(delta3)*sqr(yb2) - 36.0*sqr(sqr(delta2))*sqr(delta3)*yb2*ytau2 - 36.0*sqr(sqr(delta2))*sqr(delta3)*yb2*yt2 - 198.0*sqr(sqr(delta2))*sqr(delta3)*sqr(yt2) + 135.0*sqr(sqr(delta2))*sqr(yb2) + 27.0*sqr(sqr(delta2))*yb2*ytau2 + 135.0*sqr(sqr(delta2))*sqr(yt2) - 1.33226762955019e-15*sqr(delta2)*sqr(sqr(delta3))*g12*yb2 - 162.0*sqr(delta2)*sqr(sqr(delta3))*sqr(yb2) - 36.0*sqr(delta2)*sqr(sqr(delta3))*yb2*ytau2 - 36.0*sqr(delta2)*sqr(sqr(delta3))*yb2*yt2 - 162.0*sqr(delta2)*sqr(sqr(delta3))*sqr(yt2) + 2.66453525910038e-15*sqr(delta2)*sqr(delta3)*g12*yb2 - 1.77635683940025e-15*sqr(delta2)*sqr(delta3)*g12*yt2 + 648.0*sqr(delta2)*sqr(delta3)*sqr(yb2) + 162.0*sqr(delta2)*sqr(delta3)*yb2*ytau2 + 108.0*sqr(delta2)*sqr(delta3)*yb2*yt2 + 648.0*sqr(delta2)*sqr(delta3)*sqr(yt2) - 486.0*sqr(delta2)*sqr(yb2) - 162.0*sqr(delta2)*yb2*ytau2 - 486.0*sqr(delta2)*sqr(yt2) + 1.77635683940025e-15*sqr(sqr(delta3))*g12*yb2 + 243.0*sqr(sqr(delta3))*sqr(yb2) + 54.0*sqr(sqr(delta3))*yb2*ytau2 + 54.0*sqr(sqr(delta3))*yb2*yt2 + 243.0*sqr(sqr(delta3))*sqr(yt2) + 7.105427357601e-15*sqr(delta3)*g12*yb2 - 972.0*sqr(delta3)*sqr(yb2) - 243.0*sqr(delta3)*yb2*ytau2 - 162.0*sqr(delta3)*yb2*yt2 - 972.0*sqr(delta3)*sqr(yt2) + 729.0*sqr(yb2) + 243.0*yb2*ytau2 + 729.0*sqr(yt2))/(sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3)))));
a7= f * sqr(lambda) * (0);
a8= f * sqr(lambda) * (-0.933333333333333*g12*yb2 - 1.73333333333333*g12*yt2 - 6.0*g22*yb2 - 6.0*g22*yt2 - 10.6666666666667*g32*yb2 - 10.6666666666667*g32*yt2 + 36.0*sqr(yb2) + 8.0*yb2*ytau2 + 8.0*yb2*yt2 + 36.0*sqr(yt2) + 5.6*g12*yb2/sqr(delta3) + 10.4*g12*yt2/sqr(delta3) + 36.0*g22*yb2/sqr(delta3) + 36.0*g22*yt2/sqr(delta3) + 64.0*g32*yb2/sqr(delta3) + 64.0*g32*yt2/sqr(delta3) - 270.0*sqr(yb2)/sqr(delta3) - 54.0*yb2*ytau2/sqr(delta3) - 48.0*yb2*yt2/sqr(delta3) - 270.0*sqr(yt2)/sqr(delta3) - 8.4*g12*yb2/sqr(sqr(delta3)) - 15.6*g12*yt2/sqr(sqr(delta3)) - 54.0*g22*yb2/sqr(sqr(delta3)) - 54.0*g22*yt2/sqr(sqr(delta3)) - 96.0*g32*yb2/sqr(sqr(delta3)) - 96.0*g32*yt2/sqr(sqr(delta3)) + 540.0*sqr(yb2)/sqr(sqr(delta3)) + 108.0*yb2*ytau2/sqr(sqr(delta3)) + 72.0*yb2*yt2/sqr(sqr(delta3)) + 540.0*sqr(yt2)/sqr(sqr(delta3)) - 270.0*sqr(yb2)/(sqr(delta3)*sqr(sqr(delta3))) - 54.0*yb2*ytau2/(sqr(delta3)*sqr(sqr(delta3))) - 270.0*sqr(yt2)/(sqr(delta3)*sqr(sqr(delta3))) - 8.88178419700125e-16*g12*yb2/sqr(delta2) - 120.0*sqr(yb2)/sqr(delta2) - 36.0*yb2*ytau2/sqr(delta2) - 24.0*yb2*yt2/sqr(delta2) - 120.0*sqr(yt2)/sqr(delta2) - 3.5527136788005e-15*g12*yb2/(sqr(delta2)*sqr(delta3)) + 972.0*sqr(yb2)/(sqr(delta2)*sqr(delta3)) + 252.0*yb2*ytau2/(sqr(delta2)*sqr(delta3)) + 144.0*yb2*yt2/(sqr(delta2)*sqr(delta3)) + 972.0*sqr(yt2)/(sqr(delta2)*sqr(delta3)) - 7.105427357601e-15*g12*yb2/(sqr(delta2)*sqr(sqr(delta3))) - 1944.0*sqr(yb2)/(sqr(delta2)*sqr(sqr(delta3))) - 540.0*yb2*ytau2/(sqr(delta2)*sqr(sqr(delta3))) - 216.0*yb2*yt2/(sqr(delta2)*sqr(sqr(delta3))) - 1944.0*sqr(yt2)/(sqr(delta2)*sqr(sqr(delta3))) + 972.0*sqr(yb2)/(sqr(delta2)*(sqr(delta3)*sqr(sqr(delta3)))) + 324.0*yb2*ytau2/(sqr(delta2)*(sqr(delta3)*sqr(sqr(delta3)))) + 972.0*sqr(yt2)/(sqr(delta2)*(sqr(delta3)*sqr(sqr(delta3)))) + 180.0*sqr(yb2)/sqr(sqr(delta2)) + 54.0*yb2*ytau2/sqr(sqr(delta2)) + 36.0*yb2*yt2/sqr(sqr(delta2)) + 180.0*sqr(yt2)/sqr(sqr(delta2)) - 1458.0*sqr(yb2)/(sqr(sqr(delta2))*sqr(delta3)) - 378.0*yb2*ytau2/(sqr(sqr(delta2))*sqr(delta3)) - 216.0*yb2*yt2/(sqr(sqr(delta2))*sqr(delta3)) - 1458.0*sqr(yt2)/(sqr(sqr(delta2))*sqr(delta3)) + 1.4210854715202e-14*g12*yb2/(sqr(sqr(delta2))*sqr(sqr(delta3))) + 2916.0*sqr(yb2)/(sqr(sqr(delta2))*sqr(sqr(delta3))) + 810.0*yb2*ytau2/(sqr(sqr(delta2))*sqr(sqr(delta3))) + 324.0*yb2*yt2/(sqr(sqr(delta2))*sqr(sqr(delta3))) + 2916.0*sqr(yt2)/(sqr(sqr(delta2))*sqr(sqr(delta3))) - 1458.0*sqr(yb2)/(sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3)))) - 486.0*yb2*ytau2/(sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3)))) - 1458.0*sqr(yt2)/(sqr(sqr(delta2))*(sqr(delta3)*sqr(sqr(delta3)))));
  ...
  //Ur
a0= f * sqr(lambda) * (yt2*(-15.6*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 - 54.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 - 96.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32 + 54.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 + 234.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yt2 - 216.0*sqr(sqr(delta2))*sqr(delta3)*yb2 - 540.0*sqr(sqr(delta2))*sqr(delta3)*yt2 + 324.0*sqr(sqr(delta2))*yb2 + 810.0*sqr(sqr(delta2))*yt2 + 31.2*sqr(delta2)*sqr(sqr(delta3))*g12 + 108.0*sqr(delta2)*sqr(sqr(delta3))*g22 + 192.0*sqr(delta2)*sqr(sqr(delta3))*g32 - 108.0*sqr(delta2)*sqr(sqr(delta3))*yb2 - 738.0*sqr(delta2)*sqr(sqr(delta3))*yt2 + 432.0*sqr(delta2)*sqr(delta3)*yb2 + 2052.0*sqr(delta2)*sqr(delta3)*yt2 - 648.0*sqr(delta2)*yb2 - 3078.0*sqr(delta2)*yt2 + 540.0*sqr(sqr(delta3))*yt2 - 1944.0*sqr(delta3)*yt2 + 2916.0*yt2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))));
a1= f * sqr(lambda) * (0);
a2= f * sqr(lambda) * (yt2*sqrt(2*sqr(delta2) - 4)*(-5.2*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 - 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 - 32.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32 + 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 + 96.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yt2 - 72.0*sqr(sqr(delta2))*sqr(delta3)*yb2 - 288.0*sqr(sqr(delta2))*sqr(delta3)*yt2 + 108.0*sqr(sqr(delta2))*yb2 + 432.0*sqr(sqr(delta2))*yt2 + 15.6*sqr(delta2)*sqr(sqr(delta3))*g12 + 54.0*sqr(delta2)*sqr(sqr(delta3))*g22 + 96.0*sqr(delta2)*sqr(sqr(delta3))*g32 - 54.0*sqr(delta2)*sqr(sqr(delta3))*yb2 - 378.0*sqr(delta2)*sqr(sqr(delta3))*yt2 - 3.5527136788005e-15*sqr(delta2)*sqr(delta3)*g12 + 216.0*sqr(delta2)*sqr(delta3)*yb2 + 1188.0*sqr(delta2)*sqr(delta3)*yt2 - 324.0*sqr(delta2)*yb2 - 1782.0*sqr(delta2)*yt2 + 270.0*sqr(sqr(delta3))*yt2 - 972.0*sqr(delta3)*yt2 + 1458.0*yt2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))));
a3= f * sqr(lambda) * (0);
a4= f * sqr(lambda) * (yt2*(-5.2*sqr(delta2)*sqr(sqr(delta3))*g12 - 18.0*sqr(delta2)*sqr(sqr(delta3))*g22 - 32.0*sqr(delta2)*sqr(sqr(delta3))*g32 + 18.0*sqr(delta2)*sqr(sqr(delta3))*yb2 + 18.0*sqr(delta2)*sqr(sqr(delta3))*yt2 - 72.0*sqr(delta2)*sqr(delta3)*yb2 + 36.0*sqr(delta2)*sqr(delta3)*yt2 + 108.0*sqr(delta2)*yb2 - 54.0*sqr(delta2)*yt2 + 90.0*sqr(sqr(delta3))*yt2 - 324.0*sqr(delta3)*yt2 + 486.0*yt2)/(sqr(sqr(delta2))*sqr(sqr(delta3))));
a5= f * sqr(lambda) * (0);
a6= f * sqr(lambda) * (yt2*sqrt(2*sqr(delta2) - 4)*(-5.2*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 - 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 - 32.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32 + 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 + 96.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yt2 - 72.0*sqr(sqr(delta2))*sqr(delta3)*yb2 - 288.0*sqr(sqr(delta2))*sqr(delta3)*yt2 + 108.0*sqr(sqr(delta2))*yb2 + 432.0*sqr(sqr(delta2))*yt2 + 15.6*sqr(delta2)*sqr(sqr(delta3))*g12 + 54.0*sqr(delta2)*sqr(sqr(delta3))*g22 + 96.0*sqr(delta2)*sqr(sqr(delta3))*g32 - 54.0*sqr(delta2)*sqr(sqr(delta3))*yb2 - 378.0*sqr(delta2)*sqr(sqr(delta3))*yt2 - 3.5527136788005e-15*sqr(delta2)*sqr(delta3)*g12 + 216.0*sqr(delta2)*sqr(delta3)*yb2 + 1188.0*sqr(delta2)*sqr(delta3)*yt2 - 324.0*sqr(delta2)*yb2 - 1782.0*sqr(delta2)*yt2 + 270.0*sqr(sqr(delta3))*yt2 - 972.0*sqr(delta3)*yt2 + 1458.0*yt2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))));
a7= f * sqr(lambda) * (0);
a8= f * sqr(lambda) * (yt2*(-3.46666666666667*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*g12 - 12.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*g22 - 21.3333333333333*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*g32 + 8.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*yb2 + 72.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*yt2 - 24.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(delta3)*yb2 - 240.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(delta3)*yt2 + 36.0*(sqr(delta2)*sqr(sqr(delta2)))*yb2 + 360.0*(sqr(delta2)*sqr(sqr(delta2)))*yt2 + 20.8*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 + 72.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 + 128.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32 - 72.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 - 516.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yt2 + 288.0*sqr(sqr(delta2))*sqr(delta3)*yb2 + 1800.0*sqr(sqr(delta2))*sqr(delta3)*yt2 - 432.0*sqr(sqr(delta2))*yb2 - 2700.0*sqr(sqr(delta2))*yt2 - 31.2*sqr(delta2)*sqr(sqr(delta3))*g12 - 108.0*sqr(delta2)*sqr(sqr(delta3))*g22 - 192.0*sqr(delta2)*sqr(sqr(delta3))*g32 + 108.0*sqr(delta2)*sqr(sqr(delta3))*yb2 + 1044.0*sqr(delta2)*sqr(sqr(delta3))*yt2 - 432.0*sqr(delta2)*sqr(delta3)*yb2 - 3672.0*sqr(delta2)*sqr(delta3)*yt2 + 648.0*sqr(delta2)*yb2 + 5508.0*sqr(delta2)*yt2 - 540.0*sqr(sqr(delta3))*yt2 + 1944.0*sqr(delta3)*yt2 - 2916.0*yt2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))));
 ...
 */
  ...
  //Dr
a0= f * sqr(lambda) * (yb2*(-8.4*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 - 54.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 - 96.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32 + 234.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 + 36.0*sqr(sqr(delta2))*sqr(sqr(delta3))*ytau2 + 54.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yt2 - 540.0*sqr(sqr(delta2))*sqr(delta3)*yb2 - 108.0*sqr(sqr(delta2))*sqr(delta3)*ytau2 - 216.0*sqr(sqr(delta2))*sqr(delta3)*yt2 + 810.0*sqr(sqr(delta2))*yb2 + 162.0*sqr(sqr(delta2))*ytau2 + 324.0*sqr(sqr(delta2))*yt2 + 16.8*sqr(delta2)*sqr(sqr(delta3))*g12 + 108.0*sqr(delta2)*sqr(sqr(delta3))*g22 + 192.0*sqr(delta2)*sqr(sqr(delta3))*g32 - 738.0*sqr(delta2)*sqr(sqr(delta3))*yb2 - 126.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 - 108.0*sqr(delta2)*sqr(sqr(delta3))*yt2 + 2052.0*sqr(delta2)*sqr(delta3)*yb2 + 540.0*sqr(delta2)*sqr(delta3)*ytau2 + 432.0*sqr(delta2)*sqr(delta3)*yt2 - 3078.0*sqr(delta2)*yb2 - 810.0*sqr(delta2)*ytau2 - 648.0*sqr(delta2)*yt2 + 540.0*sqr(sqr(delta3))*yb2 + 108.0*sqr(sqr(delta3))*ytau2 - 1944.0*sqr(delta3)*yb2 - 648.0*sqr(delta3)*ytau2 + 2916.0*yb2 + 972.0*ytau2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))));
a1= f * sqr(lambda) * (0);
a2= f * sqr(lambda) * (yb2*sqrt(2*sqr(delta2) - 4)*(-2.8*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 - 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 - 32.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32 + 96.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 + 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*ytau2 + 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yt2 - 2.66453525910038e-15*sqr(sqr(delta2))*sqr(delta3)*g12 - 288.0*sqr(sqr(delta2))*sqr(delta3)*yb2 - 72.0*sqr(sqr(delta2))*sqr(delta3)*ytau2 - 72.0*sqr(sqr(delta2))*sqr(delta3)*yt2 + 3.5527136788005e-15*sqr(sqr(delta2))*g12 + 432.0*sqr(sqr(delta2))*yb2 + 108.0*sqr(sqr(delta2))*ytau2 + 108.0*sqr(sqr(delta2))*yt2 + 8.4*sqr(delta2)*sqr(sqr(delta3))*g12 + 54.0*sqr(delta2)*sqr(sqr(delta3))*g22 + 96.0*sqr(delta2)*sqr(sqr(delta3))*g32 - 378.0*sqr(delta2)*sqr(sqr(delta3))*yb2 - 72.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 - 54.0*sqr(delta2)*sqr(sqr(delta3))*yt2 + 5.32907051820075e-15*sqr(delta2)*sqr(delta3)*g12 + 1188.0*sqr(delta2)*sqr(delta3)*yb2 + 324.0*sqr(delta2)*sqr(delta3)*ytau2 + 216.0*sqr(delta2)*sqr(delta3)*yt2 + 1.4210854715202e-14*sqr(delta2)*g12 - 1782.0*sqr(delta2)*yb2 - 486.0*sqr(delta2)*ytau2 - 324.0*sqr(delta2)*yt2 + 270.0*sqr(sqr(delta3))*yb2 + 54.0*sqr(sqr(delta3))*ytau2 - 972.0*sqr(delta3)*yb2 - 324.0*sqr(delta3)*ytau2 + 1458.0*yb2 + 486.0*ytau2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))));
a3= f * sqr(lambda) * (0);
a4= f * sqr(lambda) * (yb2*(-2.8*sqr(delta2)*sqr(sqr(delta3))*g12 - 18.0*sqr(delta2)*sqr(sqr(delta3))*g22 - 32.0*sqr(delta2)*sqr(sqr(delta3))*g32 + 18.0*sqr(delta2)*sqr(sqr(delta3))*yb2 + 18.0*sqr(delta2)*sqr(sqr(delta3))*yt2 - 1.77635683940025e-15*sqr(delta2)*sqr(delta3)*g12 + 36.0*sqr(delta2)*sqr(delta3)*yb2 + 36.0*sqr(delta2)*sqr(delta3)*ytau2 - 72.0*sqr(delta2)*sqr(delta3)*yt2 - 54.0*sqr(delta2)*yb2 - 54.0*sqr(delta2)*ytau2 + 108.0*sqr(delta2)*yt2 + 90.0*sqr(sqr(delta3))*yb2 + 18.0*sqr(sqr(delta3))*ytau2 - 324.0*sqr(delta3)*yb2 - 108.0*sqr(delta3)*ytau2 + 486.0*yb2 + 162.0*ytau2)/(sqr(sqr(delta2))*sqr(sqr(delta3))));
a5= f * sqr(lambda) * (0);
a6= f * sqr(lambda) * (yb2*sqrt(2*sqr(delta2) - 4)*(-2.8*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 - 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 - 32.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32 + 96.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 + 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*ytau2 + 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yt2 - 2.66453525910038e-15*sqr(sqr(delta2))*sqr(delta3)*g12 - 288.0*sqr(sqr(delta2))*sqr(delta3)*yb2 - 72.0*sqr(sqr(delta2))*sqr(delta3)*ytau2 - 72.0*sqr(sqr(delta2))*sqr(delta3)*yt2 + 3.5527136788005e-15*sqr(sqr(delta2))*g12 + 432.0*sqr(sqr(delta2))*yb2 + 108.0*sqr(sqr(delta2))*ytau2 + 108.0*sqr(sqr(delta2))*yt2 + 8.4*sqr(delta2)*sqr(sqr(delta3))*g12 + 54.0*sqr(delta2)*sqr(sqr(delta3))*g22 + 96.0*sqr(delta2)*sqr(sqr(delta3))*g32 - 378.0*sqr(delta2)*sqr(sqr(delta3))*yb2 - 72.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 - 54.0*sqr(delta2)*sqr(sqr(delta3))*yt2 + 5.32907051820075e-15*sqr(delta2)*sqr(delta3)*g12 + 1188.0*sqr(delta2)*sqr(delta3)*yb2 + 324.0*sqr(delta2)*sqr(delta3)*ytau2 + 216.0*sqr(delta2)*sqr(delta3)*yt2 + 1.4210854715202e-14*sqr(delta2)*g12 - 1782.0*sqr(delta2)*yb2 - 486.0*sqr(delta2)*ytau2 - 324.0*sqr(delta2)*yt2 + 270.0*sqr(sqr(delta3))*yb2 + 54.0*sqr(sqr(delta3))*ytau2 - 972.0*sqr(delta3)*yb2 - 324.0*sqr(delta3)*ytau2 + 1458.0*yb2 + 486.0*ytau2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))));
a7= f * sqr(lambda) * (0);
a8= f * sqr(lambda) * (yb2*(-1.86666666666667*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*g12 - 12.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*g22 - 21.3333333333333*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*g32 + 72.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*yb2 + 16.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*ytau2 + 8.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*yt2 - 1.77635683940025e-15*(sqr(delta2)*sqr(sqr(delta2)))*sqr(delta3)*g12 - 240.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(delta3)*yb2 - 72.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(delta3)*ytau2 - 24.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(delta3)*yt2 + 360.0*(sqr(delta2)*sqr(sqr(delta2)))*yb2 + 108.0*(sqr(delta2)*sqr(sqr(delta2)))*ytau2 + 36.0*(sqr(delta2)*sqr(sqr(delta2)))*yt2 + 11.2*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 + 72.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 + 128.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32 - 516.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 - 108.0*sqr(sqr(delta2))*sqr(sqr(delta3))*ytau2 - 72.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yt2 - 7.105427357601e-15*sqr(sqr(delta2))*sqr(delta3)*g12 + 1800.0*sqr(sqr(delta2))*sqr(delta3)*yb2 + 504.0*sqr(sqr(delta2))*sqr(delta3)*ytau2 + 288.0*sqr(sqr(delta2))*sqr(delta3)*yt2 - 2700.0*sqr(sqr(delta2))*yb2 - 756.0*sqr(sqr(delta2))*ytau2 - 432.0*sqr(sqr(delta2))*yt2 - 16.8*sqr(delta2)*sqr(sqr(delta3))*g12 - 108.0*sqr(delta2)*sqr(sqr(delta3))*g22 - 192.0*sqr(delta2)*sqr(sqr(delta3))*g32 + 1044.0*sqr(delta2)*sqr(sqr(delta3))*yb2 + 216.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 + 108.0*sqr(delta2)*sqr(sqr(delta3))*yt2 - 1.4210854715202e-14*sqr(delta2)*sqr(delta3)*g12 - 3672.0*sqr(delta2)*sqr(delta3)*yb2 - 1080.0*sqr(delta2)*sqr(delta3)*ytau2 - 432.0*sqr(delta2)*sqr(delta3)*yt2 + 2.8421709430404e-14*sqr(delta2)*g12 + 5508.0*sqr(delta2)*yb2 + 1620.0*sqr(delta2)*ytau2 + 648.0*sqr(delta2)*yt2 - 540.0*sqr(sqr(delta3))*yb2 - 108.0*sqr(sqr(delta3))*ytau2 + 1944.0*sqr(delta3)*yb2 + 648.0*sqr(delta3)*ytau2 - 2916.0*yb2 - 972.0*ytau2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))));
...
a8= f * sqr(lambda) * (yb2*(-1.86666666666667*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*g12 - 12.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*g22 - 21.3333333333333*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*g32 + 72.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*yb2 + 16.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*ytau2 + 8.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*yt2 - 1.77635683940025e-15*(sqr(delta2)*sqr(sqr(delta2)))*sqr(delta3)*g12 - 240.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(delta3)*yb2 - 72.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(delta3)*ytau2 - 24.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(delta3)*yt2 + 360.0*(sqr(delta2)*sqr(sqr(delta2)))*yb2 + 108.0*(sqr(delta2)*sqr(sqr(delta2)))*ytau2 + 36.0*(sqr(delta2)*sqr(sqr(delta2)))*yt2 + 11.2*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 + 72.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 + 128.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g32 - 516.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 - 108.0*sqr(sqr(delta2))*sqr(sqr(delta3))*ytau2 - 72.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yt2 - 7.105427357601e-15*sqr(sqr(delta2))*sqr(delta3)*g12 + 1800.0*sqr(sqr(delta2))*sqr(delta3)*yb2 + 504.0*sqr(sqr(delta2))*sqr(delta3)*ytau2 + 288.0*sqr(sqr(delta2))*sqr(delta3)*yt2 - 2700.0*sqr(sqr(delta2))*yb2 - 756.0*sqr(sqr(delta2))*ytau2 - 432.0*sqr(sqr(delta2))*yt2 - 16.8*sqr(delta2)*sqr(sqr(delta3))*g12 - 108.0*sqr(delta2)*sqr(sqr(delta3))*g22 - 192.0*sqr(delta2)*sqr(sqr(delta3))*g32 + 1044.0*sqr(delta2)*sqr(sqr(delta3))*yb2 + 216.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 + 108.0*sqr(delta2)*sqr(sqr(delta3))*yt2 - 1.4210854715202e-14*sqr(delta2)*sqr(delta3)*g12 - 3672.0*sqr(delta2)*sqr(delta3)*yb2 - 1080.0*sqr(delta2)*sqr(delta3)*ytau2 - 432.0*sqr(delta2)*sqr(delta3)*yt2 + 2.8421709430404e-14*sqr(delta2)*g12 + 5508.0*sqr(delta2)*yb2 + 1620.0*sqr(delta2)*ytau2 + 648.0*sqr(delta2)*yt2 - 540.0*sqr(sqr(delta3))*yb2 - 108.0*sqr(sqr(delta3))*ytau2 + 1944.0*sqr(delta3)*yb2 + 648.0*sqr(delta3)*ytau2 - 2916.0*yb2 - 972.0*ytau2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))));
  ...
  //Er
a0= f * sqr(lambda) * (ytau2*(-32.4*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 - 54.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 + 108.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 + 162.0*sqr(sqr(delta2))*sqr(sqr(delta3))*ytau2 - 324.0*sqr(sqr(delta2))*sqr(delta3)*yb2 - 324.0*sqr(sqr(delta2))*sqr(delta3)*ytau2 + 486.0*sqr(sqr(delta2))*yb2 + 486.0*sqr(sqr(delta2))*ytau2 + 64.8*sqr(delta2)*sqr(sqr(delta3))*g12 + 108.0*sqr(delta2)*sqr(sqr(delta3))*g22 - 378.0*sqr(delta2)*sqr(sqr(delta3))*yb2 - 486.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 + 1620.0*sqr(delta2)*sqr(delta3)*yb2 + 972.0*sqr(delta2)*sqr(delta3)*ytau2 - 2430.0*sqr(delta2)*yb2 - 1458.0*sqr(delta2)*ytau2 + 324.0*sqr(sqr(delta3))*yb2 + 324.0*sqr(sqr(delta3))*ytau2 - 1944.0*sqr(delta3)*yb2 - 648.0*sqr(delta3)*ytau2 + 2916.0*yb2 + 972.0*ytau2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))));
a1= f * sqr(lambda) * (0);
a2= f * sqr(lambda) * (ytau2*sqrt(2*sqr(delta2) - 4)*(-10.8*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 - 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 + 54.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 + 60.0*sqr(sqr(delta2))*sqr(sqr(delta3))*ytau2 + 1.06581410364017e-14*sqr(sqr(delta2))*sqr(delta3)*g12 - 216.0*sqr(sqr(delta2))*sqr(delta3)*yb2 - 144.0*sqr(sqr(delta2))*sqr(delta3)*ytau2 - 1.4210854715202e-14*sqr(sqr(delta2))*g12 + 324.0*sqr(sqr(delta2))*yb2 + 216.0*sqr(sqr(delta2))*ytau2 + 32.4*sqr(delta2)*sqr(sqr(delta3))*g12 + 54.0*sqr(delta2)*sqr(sqr(delta3))*g22 - 216.0*sqr(delta2)*sqr(sqr(delta3))*yb2 - 234.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 - 2.1316282072803e-14*sqr(delta2)*sqr(delta3)*g12 + 972.0*sqr(delta2)*sqr(delta3)*yb2 + 540.0*sqr(delta2)*sqr(delta3)*ytau2 - 5.6843418860808e-14*sqr(delta2)*g12 - 1458.0*sqr(delta2)*yb2 - 810.0*sqr(delta2)*ytau2 + 162.0*sqr(sqr(delta3))*yb2 + 162.0*sqr(sqr(delta3))*ytau2 - 972.0*sqr(delta3)*yb2 - 324.0*sqr(delta3)*ytau2 + 1458.0*yb2 + 486.0*ytau2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))));
a3= f * sqr(lambda) * (0);
a4= f * sqr(lambda) * (ytau2*(-10.8*sqr(delta2)*sqr(sqr(delta3))*g12 - 18.0*sqr(delta2)*sqr(sqr(delta3))*g22 + 18.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 + 7.105427357601e-15*sqr(delta2)*sqr(delta3)*g12 + 108.0*sqr(delta2)*sqr(delta3)*yb2 - 36.0*sqr(delta2)*sqr(delta3)*ytau2 - 162.0*sqr(delta2)*yb2 + 54.0*sqr(delta2)*ytau2 + 54.0*sqr(sqr(delta3))*yb2 + 54.0*sqr(sqr(delta3))*ytau2 - 324.0*sqr(delta3)*yb2 - 108.0*sqr(delta3)*ytau2 + 486.0*yb2 + 162.0*ytau2)/(sqr(sqr(delta2))*sqr(sqr(delta3))));
a5= f * sqr(lambda) * (0);
a6= f * sqr(lambda) * (ytau2*sqrt(2*sqr(delta2) - 4)*(-10.8*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 - 18.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 + 54.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 + 60.0*sqr(sqr(delta2))*sqr(sqr(delta3))*ytau2 + 1.06581410364017e-14*sqr(sqr(delta2))*sqr(delta3)*g12 - 216.0*sqr(sqr(delta2))*sqr(delta3)*yb2 - 144.0*sqr(sqr(delta2))*sqr(delta3)*ytau2 - 1.4210854715202e-14*sqr(sqr(delta2))*g12 + 324.0*sqr(sqr(delta2))*yb2 + 216.0*sqr(sqr(delta2))*ytau2 + 32.4*sqr(delta2)*sqr(sqr(delta3))*g12 + 54.0*sqr(delta2)*sqr(sqr(delta3))*g22 - 216.0*sqr(delta2)*sqr(sqr(delta3))*yb2 - 234.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 - 2.1316282072803e-14*sqr(delta2)*sqr(delta3)*g12 + 972.0*sqr(delta2)*sqr(delta3)*yb2 + 540.0*sqr(delta2)*sqr(delta3)*ytau2 - 5.6843418860808e-14*sqr(delta2)*g12 - 1458.0*sqr(delta2)*yb2 - 810.0*sqr(delta2)*ytau2 + 162.0*sqr(sqr(delta3))*yb2 + 162.0*sqr(sqr(delta3))*ytau2 - 972.0*sqr(delta3)*yb2 - 324.0*sqr(delta3)*ytau2 + 1458.0*yb2 + 486.0*ytau2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))));
a7= f * sqr(lambda) * (0);
a8= f * sqr(lambda) * (ytau2*(-7.2*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*g12 - 12.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*g22 + 48.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*yb2 + 40.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))*ytau2 + 7.105427357601e-15*(sqr(delta2)*sqr(sqr(delta2)))*sqr(delta3)*g12 - 216.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(delta3)*yb2 - 96.0*(sqr(delta2)*sqr(sqr(delta2)))*sqr(delta3)*ytau2 + 324.0*(sqr(delta2)*sqr(sqr(delta2)))*yb2 + 144.0*(sqr(delta2)*sqr(sqr(delta2)))*ytau2 + 43.2*sqr(sqr(delta2))*sqr(sqr(delta3))*g12 + 72.0*sqr(sqr(delta2))*sqr(sqr(delta3))*g22 - 324.0*sqr(sqr(delta2))*sqr(sqr(delta3))*yb2 - 300.0*sqr(sqr(delta2))*sqr(sqr(delta3))*ytau2 + 2.8421709430404e-14*sqr(sqr(delta2))*sqr(delta3)*g12 + 1512.0*sqr(sqr(delta2))*sqr(delta3)*yb2 + 792.0*sqr(sqr(delta2))*sqr(delta3)*ytau2 - 2268.0*sqr(sqr(delta2))*yb2 - 1188.0*sqr(sqr(delta2))*ytau2 - 64.8*sqr(delta2)*sqr(sqr(delta3))*g12 - 108.0*sqr(delta2)*sqr(sqr(delta3))*g22 + 648.0*sqr(delta2)*sqr(sqr(delta3))*yb2 + 612.0*sqr(delta2)*sqr(sqr(delta3))*ytau2 + 5.6843418860808e-14*sqr(delta2)*sqr(delta3)*g12 - 3240.0*sqr(delta2)*sqr(delta3)*yb2 - 1512.0*sqr(delta2)*sqr(delta3)*ytau2 - 1.13686837721616e-13*sqr(delta2)*g12 + 4860.0*sqr(delta2)*yb2 + 2268.0*sqr(delta2)*ytau2 - 324.0*sqr(sqr(delta3))*yb2 - 324.0*sqr(sqr(delta3))*ytau2 + 1944.0*sqr(delta3)*yb2 + 648.0*sqr(delta3)*ytau2 - 2916.0*yb2 - 972.0*ytau2)/((sqr(delta2)*sqr(sqr(delta2)))*sqr(sqr(delta3))));
  ...
  if(beta3 == 0)
  {
  	setTrilinearElement(UA, 1, 3, 0);
  	setTrilinearElement(DA, 1, 3, 0);
  	setTrilinearElement(EA, 1, 3, 0);
  }
  else
  {
  	setTrilinearElement(UA, 1, 3, -lambda * 3*yt*sqrt(2*sqr(delta3) - 4)*(sqr(delta3)*yb2 + sqr(delta3)*yt2 - 3*yb2 - 3*yt2)/sqr(sqr(delta3)) * beta3 / sqrt(sqr(beta3)));
  	setTrilinearElement(DA, 1, 3, -lambda * yb * 3 * sqrt(2*sqr(delta3) - 4)*(sqr(delta3)*yb2 + sqr(delta3)*yt2 - 3*yb2 - 3*yt2)/sqr(sqr(delta3)) * beta3 / sqrt(sqr(beta3)));
  	setTrilinearElement(EA, 1, 3, -lambda * ytau * ytau2  * (sqrt(2*sqr(delta3) - 4)*(3*sqr(delta3) - 9)/sqr(sqr(delta3))) * beta3 / sqrt(sqr(beta3)));
  }
  if(beta2 ==0)
  {
  	setTrilinearElement(UA, 3, 1, 0);
  	setTrilinearElement(DA, 3, 1, 0);
  	setTrilinearElement(EA, 3, 1, 0);  
  }
  else
  {
  	setTrilinearElement(UA, 3, 1, -lambda * yt * yt2 *sqrt(2*sqr(delta2) - 4)*(6*sqr(delta2) - 18)/sqr(sqr(delta2))* beta2 / sqrt(sqr(beta2)));
  	setTrilinearElement(DA, 3, 1, -lambda * yb * yb2 *sqrt(2*sqr(delta2) - 4)*(6*sqr(delta2) - 18)/sqr(sqr(delta2)) * beta2 / sqrt(sqr(beta2)));
  	setTrilinearElement(EA, 3, 1, -lambda * ytau * ytau2  * (sqrt(2*sqr(delta2) - 4)*(6*sqr(delta2) - 18)/sqr(sqr(delta2))) * beta2 / sqrt(sqr(beta2)));
  }
  //
...
void MssmSoftPars::FGMCaseB1Large(const MssmSusy & xx, double LAMBDA, 
			       double mMess,  double cgrav) {
...
void MssmSoftPars::FGMCaseBNonRN(const MssmSusy & xx, double LAMBDA, 
...
void MssmSoftPars::FGMCaseBNonRN3(const MssmSusy & xx, double LAMBDA, 
             double mMess, double beta2, double beta3, double betaeps, double thetavev, double cgrav) {
...
a0 = f * sqr(lambda)* (0.);
a1 = f * sqr(lambda)* (0.);
a2 = f * sqr(lambda)* (0.008838834764831844*beta3*betaeps*(360.*g22*(pow(yb,2) + pow(yt,2)) + 640.*g32*(pow(yb,2) + pow(yt,2)) + 
     8.*g12*(7.*pow(yb,2) + 13.*pow(yt,2)) - 15.*(49.*pow(yb,4) + 49.*pow(yt,4) + 
        pow(yb,2)*(20.*pow(yt,2) + 9.*pow(ytau,2)))));
a3 = f * sqr(lambda)* (0.);
a4 = f * sqr(lambda)* (0.0125*(-360.*g22*(pow(yb,2) + pow(yt,2)) - 640.*g32*(pow(yb,2) + pow(yt,2)) - 8.*g12*(7.*pow(yb,2) + 13.*pow(yt,2)) + 
     15.*(65.*pow(yb,4) + 65.*pow(yt,4) + pow(yb,2)*(20.*pow(yt,2) + 9.*pow(ytau,2))) + 
     3.4641016151377544*betaeps*(4.*g12*(7.*yb + 13.*yt) + 
        5.*(yb + yt)*(36.*g22 + 64.*g32 - 194.*pow(yb,2) + 163.*yb*yt - 194.*pow(yt,2)) - 75.*pow(yb,2)*ytau - 
        70.*yb*pow(ytau,2))*(cos(thetavev) + sin(thetavev))));
a5 = f * sqr(lambda)* (0.4330127018922193*betaeps*pow(yb - 1.*yt,2)*(yb + yt)*(cos(thetavev) - 1.*sin(thetavev)));
a6 = f * sqr(lambda)* (0.008838834764831844*beta3*betaeps*(360.*g22*(pow(yb,2) + pow(yt,2)) + 640.*g32*(pow(yb,2) + pow(yt,2)) + 
     8.*g12*(7.*pow(yb,2) + 13.*pow(yt,2)) - 15.*(49.*pow(yb,4) + 49.*pow(yt,4) + 
        pow(yb,2)*(20.*pow(yt,2) + 9.*pow(ytau,2)))));
a7 = f * sqr(lambda)* (0.4330127018922193*betaeps*pow(yb - 1.*yt,2)*(yb + yt)*(cos(thetavev) - 1.*sin(thetavev)));
a8 = f * sqr(lambda)* (0.004166666666666667*(-360.*g22*(pow(yb,2) + pow(yt,2)) - 640.*g32*(pow(yb,2) + pow(yt,2)) - 
     8.*g12*(7.*pow(yb,2) + 13.*pow(yt,2)) + 15.*(39.*pow(yb,4) + 39.*pow(yt,4) + 
        pow(yb,2)*(20.*pow(yt,2) + 11.*pow(ytau,2))) + 
     3.4641016151377544*betaeps*(4.*g12*(7.*yb + 13.*yt) + 
        5.*(yb + yt)*(36.*g22 + 64.*g32 - 138.*pow(yb,2) + 111.*yb*yt - 138.*pow(yt,2)) - 75.*pow(yb,2)*ytau - 
        90.*yb*pow(ytau,2))*(cos(thetavev) + sin(thetavev))));
...
a0 = f * sqr(lambda)* (0.);
a1 = f * sqr(lambda)* (0.);
a2 = f * sqr(lambda)* (0.017677669529663688*beta2*betaeps*pow(yt,2)*(104.*g12 + 360.*g22 + 640.*g32 - 180.*pow(yb,2) - 705.*pow(yt,2)));
a3 = f * sqr(lambda)* (0.);
a4 = f * sqr(lambda)* (0.025*yt*(-4.*(26.*g12 + 90.*g22 + 160.*g32 - 45.*pow(yb,2))*yt + 945.*pow(yt,3) + 
     3.4641016151377544*betaeps*(52.*g12 + 5.*(36.*g22 + 64.*g32 - 3.*(6.*pow(yb,2) + 5.*yb*yt + 64.*pow(yt,2))))*
      (cos(thetavev) + sin(thetavev))));
a5 = f * sqr(lambda)* (0.);
a6 = f * sqr(lambda)* (0.017677669529663688*beta2*betaeps*pow(yt,2)*(104.*g12 + 360.*g22 + 640.*g32 - 180.*pow(yb,2) - 705.*pow(yt,2)));
a7 = f * sqr(lambda)* (0.);
a8 = f * sqr(lambda)* (0.008333333333333333*yt*(-4.*(26.*g12 + 90.*g22 + 160.*g32 - 15.*pow(yb,2))*yt + 675.*pow(yt,3) + 
     3.4641016151377544*betaeps*(52.*g12 + 5.*(36.*g22 + 64.*g32 - 3.*(6.*pow(yb,2) + yb*yt + 48.*pow(yt,2))))*
      (cos(thetavev) + sin(thetavev))));
/* 
cout <<"UR"<<endl;
cout <<"a0="<<a0 <<endl;
...
a0 = f * sqr(lambda)* (0.);
a1 = f * sqr(lambda)* (0.);
a2 = f * sqr(lambda)* (0.017677669529663688*beta2*betaeps*pow(yb,2)*(56.*g12 + 
     5.*(72.*g22 + 128.*g32 - 141.*pow(yb,2) - 36.*pow(yt,2) - 75.*pow(ytau,2))));
a3 = f * sqr(lambda)* (0.);
a4 = f * sqr(lambda)* (0.025*yb*(yb*(-56.*g12 + 5.*(-72.*g22 - 128.*g32 + 189.*pow(yb,2) + 36.*pow(yt,2) + 75.*pow(ytau,2))) + 
     3.4641016151377544*betaeps*(28.*g12 + 5.*(36.*g22 + 64.*g32 - 3.*(64.*pow(yb,2) + 5.*yb*yt + 6.*pow(yt,2)) - 39.*yb*ytau - 
           38.*pow(ytau,2)))*(cos(thetavev) + sin(thetavev))));
a5 = f * sqr(lambda)* (1.7320508075688772*betaeps*pow(yb,2)*ytau*(cos(thetavev) - 1.*sin(thetavev)));
a6 = f * sqr(lambda)* (0.017677669529663688*beta2*betaeps*pow(yb,2)*(56.*g12 + 
     5.*(72.*g22 + 128.*g32 - 141.*pow(yb,2) - 36.*pow(yt,2) - 75.*pow(ytau,2))));
a7 = f * sqr(lambda)* (1.7320508075688772*betaeps*pow(yb,2)*ytau*(cos(thetavev) - 1.*sin(thetavev)));
a8 = f * sqr(lambda)* (0.008333333333333333*yb*(yb*(-56.*g12 - 360.*g22 - 640.*g32 + 675.*pow(yb,2) + 60.*pow(yt,2) + 405.*pow(ytau,2)) + 
     3.4641016151377544*betaeps*(28.*g12 + 5.*(36.*g22 + 64.*g32 - 
           3.*(48.*pow(yb,2) + yb*yt + 6.*pow(yt,2) + 13.*yb*ytau + 14.*pow(ytau,2))))*(cos(thetavev) + sin(thetavev))));
...
a0 = f * sqr(lambda)* (0.);
a1 = f * sqr(lambda)* (0.);
a2 = f * sqr(lambda)* (0.02651650429449553*beta3*betaeps*pow(ytau,2)*(72.*g12 + 5.*(24.*g22 - 27.*pow(yb,2) - 31.*pow(ytau,2))));
a3 = f * sqr(lambda)* (0.);
a4 = f * sqr(lambda)* (0.0125*ytau*(-9.*(24.*g12 + 40.*g22 - 45.*pow(yb,2))*ytau + 705.*pow(ytau,3) + 
     3.4641016151377544*betaeps*(108.*g12 + 5.*(36.*g22 - 42.*pow(yb,2) - 45.*yb*ytau - 136.*pow(ytau,2)))*
      (cos(thetavev) + sin(thetavev))));
a5 = f * sqr(lambda)* (0.4330127018922193*betaeps*pow(ytau,3)*(cos(thetavev) - 1.*sin(thetavev)));
a6 = f * sqr(lambda)* (0.02651650429449553*beta3*betaeps*pow(ytau,2)*(72.*g12 + 5.*(24.*g22 - 27.*pow(yb,2) - 31.*pow(ytau,2))));
a7 = f * sqr(lambda)* (0.4330127018922193*betaeps*pow(ytau,3)*(cos(thetavev) - 1.*sin(thetavev)));
a8 = f * sqr(lambda)* (0.0125*ytau*(ytau*(-72.*g12 - 120.*g22 + 165.*pow(yb,2) + 85.*pow(ytau,2)) + 
     10.392304845413264*betaeps*(12.*g12 + 5.*(4.*g22 - 6.*pow(yb,2) - 5.*yb*ytau - 8.*pow(ytau,2)))*
      (cos(thetavev) + sin(thetavev))));
...
a0 = f * sqr(lambda)* (0.);
a1 = f * sqr(lambda)* (0.);
a2 = f * sqr(lambda)* (0.05303300858899106*beta2*betaeps*pow(ytau,2)*(72.*g12 + 5.*(24.*g22 - 27.*pow(yb,2) - 29.*pow(ytau,2))));
a3 = f * sqr(lambda)* (0.);
a4 = f * sqr(lambda)* (0.025*ytau*(9.*ytau*(-24.*g12 - 40.*g22 + 45.*pow(yb,2) + 75.*pow(ytau,2)) + 
     3.4641016151377544*betaeps*(108.*g12 + 5.*(36.*g22 - 42.*pow(yb,2) - 45.*yb*ytau - 134.*pow(ytau,2)))*
      (cos(thetavev) + sin(thetavev))));
a5 = f * sqr(lambda)* (0.);
a6 = f * sqr(lambda)* (0.05303300858899106*beta2*betaeps*pow(ytau,2)*(72.*g12 + 5.*(24.*g22 - 27.*pow(yb,2) - 29.*pow(ytau,2))));
a7 = f * sqr(lambda)* (0.);
a8 = f * sqr(lambda)* (0.025*ytau*(ytau*(-72.*g12 + 5.*(-24.*g22 + 33.*pow(yb,2) + 23.*pow(ytau,2))) + 
     3.4641016151377544*betaeps*(36.*g12 + 60.*g22 - 5.*(18.*pow(yb,2) + 15.*yb*ytau + 26.*pow(ytau,2)))*
      (cos(thetavev) + sin(thetavev)))); 
  ...
  //higgs masses
  double deltaHu =  f * sqr(lambda) * (1.5*pow(yt,2)*(-1.*pow(yb,2) - 3.*pow(yt,2) + 1.7320508075688772*betaeps*(yb + 3.*yt)*(cos(thetavev) + sin(thetavev))));
  
  double deltaHd =  f * sqr(lambda) *(0.5*(-3.*(3.*pow(yb,4) + pow(yb,2)*pow(yt,2) + 3.*pow(ytau,4)) + 
     5.196152422706632*betaeps*(pow(yb,2)*(3.*yb + yt) + 3.*pow(ytau,3))*(cos(thetavev) + sin(thetavev))));
  setMh1Squared(mllsq + deltaHd); //Hd
  setMh2Squared(mllsq + deltaHu); //Hu
  
  //trilinears
setTrilinearElement(UA,1,3,lambda *(1.0606601717798212*beta3*betaeps*yt*(pow(yb,2) + pow(yt,2))));
setTrilinearElement(UA,3,1,lambda *(2.1213203435596424*beta2*betaeps*pow(yt,3)));
setTrilinearElement(UA,3,3,lambda *(0.5*yt*(-1.*pow(yb,2) - 3.*pow(yt,2) + 1.7320508075688772*betaeps*(yb + 3.*yt)*(cos(thetavev) + sin(thetavev)))));

setTrilinearElement(DA,1,1,lambda *(1.0606601717798212*beta3*betaeps*yb*(pow(yb,2) + pow(yt,2))));
setTrilinearElement(DA,3,1,lambda *(2.1213203435596424*beta2*betaeps*pow(yb,3)));
setTrilinearElement(DA,3,3,lambda *(0.5*yb*(-3.*pow(yb,2) - 1.*pow(yt,2) + 1.7320508075688772*betaeps*(3.*yb + yt)*(cos(thetavev) + sin(thetavev)))));


setTrilinearElement(EA,1,3,lambda *(1.0606601717798212*beta3*betaeps*pow(ytau,3)));
setTrilinearElement(EA,1,3,lambda *(2.1213203435596424*beta2*betaeps*pow(ytau,3)));
setTrilinearElement(EA,1,3,lambda *(1.5*pow(ytau,2)*(-1.*ytau + 1.7320508075688772*betaeps*(cos(thetavev) + sin(thetavev)))));
}
}

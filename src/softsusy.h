...
namespace softsusy {
  ...
  public:
    ...
    */
    ...
    virtual void hmixSLHAHigh(ostream & out);
    /// sfermionic part of mixing blocks
    void gaugeSLHA(ostream & out);
    void gaugeSLHAHigh(ostream & out);
    /// sfermionic part of mixing blocks
    virtual void yukawasSLHA(ostream & out);
    virtual void yukawasSLHAHigh(ostream & out);
    /// MSOFT block of SLHA
    virtual void msoftSLHA(ostream & out);
    virtual void msoftSLHAHigh(ostream & out);
    ...
    virtual void drbarSLHAHigh(ostream & out, int numPoints, double qMax, int n);
